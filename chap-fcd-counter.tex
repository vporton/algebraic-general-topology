...
So $\dom G$ intersects each vertical line by atmost one element
(to prove it consider formula $p,q\in(\dom G)\cap(\{x\}\cap\mathbb{N})\Rightarrow p=q$) that
...
\mathcal{A}\rtimes\mathcal{B} & =\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}f}{f\in\mathbf{Rel}(\Base(\mathcal{A});\Base(\mathcal{B})),\forall A\in\up\mathcal{A}:\uparrow^{\mathsf{FCD}}f\sqsupseteq\uparrow^{\Base(\mathcal{A})}A\times^{\mathsf{FCD}}\mathcal{B}}.
\end{align*}
\end{defn}
\begin{prop}
...
\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}f}{f\in\mathbf{Rel}(\Base(\mathcal{A});\Base(\mathcal{B})),\forall A\in\up\mathcal{A},B\in\up\mathcal{B}:\uparrow^{\mathsf{FCD}}f\sqsupseteq\uparrow^{\Base(\mathcal{A})}A\times^{\mathsf{FCD}}\uparrow^{\Base(\mathcal{B})}B} & \sqsubseteq\\
\bigsqcap\setcond{\uparrow^{\Base(\mathcal{A})}A\times^{\mathsf{RLD}}\uparrow^{\Base(\mathcal{B})}B}{A\in\up\mathcal{A},B\in\up\mathcal{B}} & =\\
