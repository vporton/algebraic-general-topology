...
It seems that the theorem (the negation of the above example)
holds if we replace endofuncoids with complete endofuncoids
(or what is the same complete endoreloids).
