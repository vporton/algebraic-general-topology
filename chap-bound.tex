...
$E_i\in\up f$ for $i=0,\dots,n$ such that $E_i^i\sqsubseteq F$ and then $E=E_{0}\sqcap\dots\sqcap E_{n}\in\up f$. We have
...
% and so $F\supseteq E^{0}\sqcup\ldots\sqcup E^{n}$ where $E=E_{0}\sqcap\dots\sqcap E_{k}\in\up f$.
\end{proof}
\begin{prop}
