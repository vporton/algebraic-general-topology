...
$\bigsqcap_{Y\in\up y}\bigsqcap_{X\in\up x}\supfun{f}(X\times Y)=\supfun{f}(x\times^{\mathsf{FCD}} y)$
\end{proof}

\fxwarning{Rewrite below:}

Let $G$ and $H$ be endofuncoids:
\begin{itemize}
\item $\operatorname{Ob} \operatorname{HOM} ( G , H) = ( \operatorname{Ob} H)^{\operatorname{Ob} G}$;
...
$( f , g) \in \operatorname{GR} \operatorname{HOM} ( G , H) \Leftrightarrow \forall v,w\in\atoms^{\mathscr{F}}\Ob G : g \circ (v \times^{\mathsf{FCD}} w) \circ f^{- 1} \sqsubseteq \operatorname{GR} H$

$( f , g) \in \operatorname{GR} \operatorname{HOM} ( G , H) \Leftrightarrow \forall v,w\in\atoms^{\mathscr{F}}\Ob G : \supfun{f}v \times^{\mathsf{FCD}} \supfun{g}w \sqsubseteq \operatorname{GR} H$

$( f , g) \in \operatorname{GR} \operatorname{HOM} ( G , H) \Leftrightarrow g \circ G \circ f^{- 1} \sqsubseteq H$

$( f , g) \in \operatorname{GR} \operatorname{HOM} ( G , H) \Leftrightarrow \langle f \times^{( C)} g \rangle G \sqsubseteq H$

The transposition (the isomorphism) is uncurrying.

Let $\sim f=\tofcd\circ(\curry f)$. Here we consider $\bigsqcap^{\mathsf{FCD}}\circ(\curry f)$ as a principal funcoid that is binary relation:

\begin{prop}
$\tofcd\circ(\curry f)$ is a complete and co-complete pointfree funcoid.
\end{prop}
...
$\supfun{\tofcd\curry f}X$ is obviously principal.
So, it's co-complete.

And it is obviously complete.
\end{proof}

Let $f\in\Hom(A\times B,C)$ that is $f\in Z^{A\times B}$. Then $\sim f\in (\mathsf{FCD}(B,C))^{\mathscr{F}(A)}$.

If $f : A \times B \rightarrow C$ then $\sim f : \mathscr{F}(A) \rightarrow \operatorname{HOM} ( B , C)$

\begin{prop}
$\rsupfun{\bigcup\rsupfun{\curry f}X}Y = \rsupfun{f}(X\times Y)$ for sets $X$,~$Y$.
\end{prop}

\begin{proof}
$\rsupfun{\bigcup\rsupfun{\curry f}X}Y =
\setcond{\rsupfun{\bigcup_{x\in X}(\curry f)x}y}{y\in Y} =
\setcond{\bigcup_{x\in X}\rsupfun{(\curry f)x}y}{y\in Y} =
\setcond{\rsupfun{(\curry f)x}y}{x\in X,y\in Y} =
\setcond{\rsupfun{f}(x,y)}{x\in X,y\in Y} =
\rsupfun{f}(X\times Y)$.
??
\end{proof}

??Replace back by $\bigsqcup\circ\rsupfun{\curry f}$.

\begin{prop}
$\supfun{\supfun{\bigsqcup\circ\rsupfun{\curry f}}x}y = \supfun{f}(x\times^{\mathsf{RLD}} y)$ for ??.
\end{prop}

\begin{proof}
$\supfun{\supfun{\bigsqcup\circ\rsupfun{\curry f}}x}y =
\supfun{\bigsqcap_{X\in\up x}\supfun{\bigsqcup\circ\rsupfun{\curry f}}X}y = ?? =
\bigsqcap_{X\in\up x}\supfun{\rsupfun{\bigsqcup}\rsupfun{\curry f}X}y =
\bigsqcap_{X\in\up x}\rsupfun{\bigsqcup}\supfun{\rsupfun{\curry f}X}y =
\bigsqcap_{X\in\up x,Y\in\up y}\supfun{\rsupfun{\bigsqcup}\rsupfun{\curry f}X}Y =
\bigsqcap_{X\in\up x,Y\in\up y}\supfun{\rsupfun{\bigcup}\rsupfun{\curry f}X}Y = ?? =
\bigsqcap_{X\in\up x,Y\in\up y}\rsupfun{f}(X\times^{\mathsf{RLD}}Y) =
\supfun{f}(x\times^{\mathsf{RLD}} y)$.
\end{proof}

''Proposition'' Transposition and its inverse are morphisms of $\mathbf{Dig}$.

''Proof'' It follows from the equivalence $\sim f : A \rightarrow \operatorname{HOM} ( B , C) \Leftrightarrow \forall x, y\in\atoms^{\mathscr{F}}\Ob A : ( x\suprel{A}y \Rightarrow \supfun{\sim f} x \suprel{\operatorname{HOM}(B,C)} \supfun{\sim f} y) \Leftrightarrow \\
\forall x, y\in\atoms^{\mathscr{F}}\Ob A : ( x\suprel{A}y \Rightarrow \forall v,w\in\atoms^{\mathscr{F}}?:(v\times^{\mathsf{FCD}}w\sqsubseteq B\Rightarrow\supfun{\supfun{\sim f}x}v\times^{\mathsf{FCD}}\supfun{\supfun{\sim f}y}w \sqsubseteq C) \Leftrightarrow\\
\forall x,y,v,w\in\atoms^{\mathscr{F}}?:(x\suprel{A}y\land v\suprel{B}w\Rightarrow\supfun{\supfun{\sim f}x}v\times^{\mathsf{FCD}}\supfun{\supfun{\sim f}y}w \sqsubseteq C) \Leftrightarrow
\forall x,y,v,w\in\atoms^{\mathscr{F}}?:(x\times^{\mathsf{RLD}}v)\suprel{A\times B}(y\times^{\mathsf{RLD}}w)\Rightarrow\supfun{\supfun{\sim f}x}v\times^{\mathsf{FCD}}\supfun{\supfun{\sim f}y}w \sqsubseteq C) \Leftrightarrow
\forall x,y,v,w\in\atoms^{\mathscr{F}}?:(x\times^{\mathsf{RLD}}v)\suprel{A\times B}(y\times^{\mathsf{RLD}}w)\Rightarrow\supfun{\supfun{\tofcd\curry f}x}v\times^{\mathsf{FCD}}\supfun{\supfun{\tofcd\curry f}y}w \sqsubseteq C) \Leftrightarrow
??
\Leftrightarrow \forall x, y : ( x A y \Rightarrow \forall ( v , w) \in B : ( ( \sim f) x v , ( \sim f) y w) \in C) \Leftrightarrow \\ \forall x, y, v, w : ( x A y \wedge v B w \Rightarrow ( ( \sim f) x v , ( \sim f) y w) \in C) \Leftrightarrow \\ \forall x, y, v, w : ( ( x , v)  ( A \times B)  ( y , w)
\Rightarrow ( f ( x , v) , f ( y , w)) \in C) \Leftrightarrow f : A \times B \rightarrow C$.
