...
\begin{thm}
  ...
  $A_1$, $B_1$ then
  \begin{gather*}
    \bigsqcap \setcond{ a \odot^{\operatorname{proj}}_{\sqcap} b }{(a , b)\in S } =
     \bigsqcap \dom S \odot^{\operatorname{proj}}_{\sqcap} \bigsqcap \im S;\\
    \bigsqcap \setcond{ a \times^{\operatorname{proj}}_{\sqcap} b }{(a , b)\in S } =
     \bigsqcap \dom S \times^{\operatorname{proj}}_{\sqcap} \bigsqcap \im S;\\
    \bigsqcap \setcond{ a \amalg^{\operatorname{proj}}_{\sqcap} b }{(a , b)\in S } =
     \bigsqcap \dom S \amalg^{\operatorname{proj}}_{\sqcap} \bigsqcap \im S.
  \end{gather*}
\fxnote{Apparently, can be generalized for infinitary case.}
\end{thm}
...
\begin{cor}
\fxnote{Generalize for infinitary products.}
The following are pairwise equivalent whenever defined, provided
that compositions of every non-least morphisms with every
projection is non-least:
\begin{enumerate}
\item $a_0 \odot^{\operatorname{proj}}_{\sqcap} b_0 \nasymp a_1 \odot^{\operatorname{proj}}_{\sqcap} b_1$;
\item $a_0 \times^{\operatorname{proj}}_{\sqcap} b_0 \nasymp a_1 \odot^{\operatorname{proj}}_{\sqcap} b_1$;
\item $a_0 \amalg^{\operatorname{proj}}_{\sqcap} b_0 \nasymp a_1 \odot^{\operatorname{proj}}_{\sqcap} b_1$;
\item $a_0 \nasymp a_1 \wedge b_0 \nasymp b_1$.
\end{enumerate}
\end{cor}
