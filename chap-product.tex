...
\begin{proof}
$\rsupfun{\bigcup\rsupfun{\curry f}X}Y=\bigcup\setcond{\rsupfun{\bigcup\rsupfun{\curry f}X}\{y\}}{y\in Y}=
\setcond{\rsupfun{\bigcup\left(\bigcup\setcond{(\curry f)x}{x\in X}\right)}\{y\}}{y\in Y}=
\setcond{\bigcup\rsupfun{\bigcup\setcond{(\curry f)x}{x\in X}}\{y\}}{y\in Y}=
\setcond{\bigcup\bigcup_{x\in X}\setcond{\rsupfun{(\curry f)x)}\{y\}}{x\in X}}{y\in Y}=
\setcond{\bigcup\setcond{(\curry f)x)y}{x\in X}}{y\in Y}=
