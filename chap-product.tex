...
Let $\sim f=\bigsqcap^{\mathsf{FCD}}\circ\curry f$. Here we consider $\bigsqcap^{\mathsf{FCD}}\circ\curry f$ as a principal funcoid that is binary relation (it is as easy to show?? complete and co-complete).
