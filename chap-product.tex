...
\forall x,y\in\atoms^{\mathscr{F}}\Ob A, p,q\in\atoms^{\mathscr{F}}\Ob B:
((x\times^{\mathsf{FCD}}p)\times^{\mathsf{RLD}}(y\times^{\mathsf{FCD}}q)\sqsubseteq A\times^{(C)}B \Rightarrow f\circ((x\times^{\mathsf{FCD}}p)\times^{\mathsf{FCD}}(y\times^{\mathsf{FCD}}q))\circ f^{-1} \sqsubseteq C) \Leftrightarrow?? \\
\forall x,y\in\atoms^{\mathscr{F}}\Ob A, p,q\in\atoms^{\mathscr{F}}\Ob B:
((x\times^{\mathsf{FCD}}p)\times^{\mathsf{FCD}}(y\times^{\mathsf{FCD}}q)\sqsubseteq A\times^{\mathsf{FCD}}B \Rightarrow f\circ((x\times^{\mathsf{FCD}}p)\times^{\mathsf{FCD}}(y\times^{\mathsf{FCD}}q))\circ f^{-1} \sqsubseteq C) \Leftrightarrow?? \\
f\circ(A\times^{\mathsf{FCD}}B)\circ f^{-1} \sqsubseteq C) \Leftrightarrow
f : A\times^{\mathsf{FCD}}B \rightarrow C$.
\end{proof}
