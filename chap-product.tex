...
''Proposition'' Transposition and its inverse are morphisms of $\mathbf{Fcd}$.
...
\forall x,y\in\atoms^{\mathscr{F}}\Ob A, p,q\in\atoms^{\mathscr{F}}\Ob B:
(x\times^{\mathsf{FCD}}p\suprel{A\times^{(C)}B}y\times^{\mathsf{FCD}}q \Rightarrow \supfun{f}(x\times^{\mathsf{FCD}}p)\times^{\mathsf{FCD}}\supfun{f}(y\times^{\mathsf{FCD}}q) \sqsubseteq C) \Leftrightarrow \\
??????????????\\
