...
\fxwarning{Check again if this holds for $S$ being a filter base on the set of funcoids,
on the set of $\mathbf{Rel}$-morphisms or both. Isn't one a special case of the other?}
