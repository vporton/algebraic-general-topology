...
on $A$ which is antisymmetric ($\opinparens{\sqsubseteq}\cap\opinparens{\sqsubseteq}\subseteq\eqinparens$).
\end{defn}
...
\begin{thm}
\index{Morgan's laws}(De Morgan's laws) For every elements $a$,
...
\begin{thm}
\index{De Morgan's laws!infinite}(infinite De Morgan's laws) For
...
\begin{defn}
The set $\Mor(A;B)$ (also denoted as $\Mor_{C}(A;B)$ or just $C(A;B)$,
