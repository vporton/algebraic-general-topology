...
\begin{defn}
\index{set!partially ordered}A set $A$ together with
...
\begin{defn}
\index{atom}An atom of a poset is an element~$a$ such that
...
\item[$\Leftarrow$] We need to prove only that $x$ is least implies that $x\sqsubset a$ but this follows from $a$ being non-least.
\end{description}
