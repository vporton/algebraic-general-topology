...
\chapter{Typed sets and category $\mathbf{Rel}$}
...
morphisms (functions) are considered.
\begin{defn}
...
\item $\forall y\in B,a,b\in A:(a\mathrel fy\land b\mathrel fy\Rightarrow a\ne b)$;
\item $\forall y\in B,a,b\in A:(a=b\Rightarrow\lnot(a\mathrel fy)\lor\lnot(b\mathrel fy))$;
\item $\forall y\in B:(a=b\Rightarrow\forall a,b\in A:(\lnot(a\mathrel fy)\lor\lnot(b\mathrel fy)))$;
\item $\forall y\in B:(\exists a,b\in A:(a\mathrel fy\land b\mathrel fy)\Rightarrow a\ne b)$;
...
for sets $X$ and $Y$;
\item \label{br-at-f}$\rsupfun fX=\bigcup\rsupfun{\rsupfun f}X$ for a
set $X$.
\end{enumerate}
\end{prop}
\begin{proof}
...
then $fx\in\atoms^{\mathscr{T}\Dst f}$ and thus 
\begin{multline*}
