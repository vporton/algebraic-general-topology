...
\emph{Hausdorff} space~$a$ can be defined as having $x\mathrel{\overline{Ra}}y$ whenever~$x$ and $y$ are closed and $x\asymp y$ or as $f^{-1}\circ f$ being $T_1$-separable.
