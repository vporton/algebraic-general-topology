...
Every ordered precategory action~$\supfun{}$ defines a relation~$\suprel{}$: $x\suprel{a}y\Leftrightarrow y\nasymp\supfun{a}x$.
...
$T_1$-space~$a$ when $x\mathrel{\overline{\suprel{\Cor a}}}y$ for every $x\asymp y$.
...
\section{Equivalence of continuity formulas}

These theorems were proved in~\cite{volume-1}:
