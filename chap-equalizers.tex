...
\begin{defn}
  ...
  other words, $\mathcal{E}^{\mathcal{C}} = \uparrow \circ \mathcal{E}$.
...
\begin{cor}
  $\mahcal{E}^{B,C} \circ \mathcal{E}^{A,B} = \mathcal{E}_{\mathcal{C}}^{A,C}$ if
...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    1^{\mathbf{Rel}}_B$; $(\mathcal{E}^{A,B}) \circ (\mathcal{E}^{A,B})^{- 1} \sqsubseteq 1^{\mathbf{Rel}}_B$; $(A
    ...
    1^{\mathbf{Rel}}_A$; $(\mathcal{E}^{A,B})^{- 1} \circ \mathcal{E}^{A,B} \sqsubseteq 1^{\mathbf{Rel}}_A$; $(A
    ...
    $\mathcal{E}_{\mathcal{C}}^{A,B} \circ (A \rightleftarrows^{\mathcal{C}}
