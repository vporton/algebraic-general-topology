...
\mathscr{C}$. \fxwarning{Probably should include the improper filter. (It has the advantage that meet of any lower filters is a lower filter.)}
\fxnote{It can alternatively be described as being a lower set of filters.}
\end{defn}
...
\fxnote{Isn't it the same as $\GR\mu\subseteq\GR\nu$?}
