...
\fxnote{Also do $(\mathsf{RLD})_{\Low}$ and $(\Low)$ preserve lattice operations for lattices of complete low spaces and of Cauchy spaces (and complete Cauchy spaces?).}
