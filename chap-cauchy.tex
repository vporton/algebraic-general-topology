...
\fxwarning{Rename ``low spaces'' into ``filter spaces'' following
\url{http://link.springer.com/article/10.1007/s10474-011-0136-9} (``A note on Cauchy spaces''). It also contains references to some useful results,
including that the category $\mathrm{FIL}$ of filter spaces is isomorphic to
the category of filter meretopic spaces (what is it?)}
...
\begin{prop}
  ...
  \fxwarning{Isn't it enough to be a completely quasi upward directed low space?}
