...
\begin{prop}
The set of low spaces (on some fixed set), whose graphs are almost sub-join-semilattices, is meet-closed in the lattice of low spaces on a set.
\end{prop}

\begin{proof}
Let $f$, $g$ be low spaces, whose graphs are almost sub-join-semilattices (on some fixed set), $\GR(f\sqcap g) = \setcond{F\sqcap G}{F\in\GR f,G\in\GR g}$.
...
\begin{prop}
The set of low spaces, whose graphs are almost completely sub-join-semilattices, is meet-closed in the lattice of low spaces on a set.
\end{prop}

\begin{proof}
Let $S$~be a set of low spaces, whose graphs are almost completely sub-join-semilattices (on some fixed set). $\GR \bigsqcap S = \setcond{ \bigsqcap
...
\begin{enumerate}
\item low spaces, whose graphs are almost sub-join-semilattices;
\item low spaces, whose graphs are completely almost sub-join-semilattices;
...
\begin{lem}
For low spaces~$f$, $g$, whose graphs are sub-join-semilattices
\[
\GR f\cup\GR g\cup Z(\GR f\cup\GR g)\cup Z(Z(\GR f\cup\GR g))\cup\dots
\]
is a sub-join-semilattice and a graph of some low space.
\end{lem}
...
\begin{prop}
Binary join on the lattice of low spaces whose graphs are almost sub-join-semilattices spaces is described by the formula
\[
\GR f\cup\GR g\cup Z(\GR f\cup\GR g)\cup Z(Z(\GR f\cup\GR g))\cup\dots.
\]
\end{prop}
...
\begin{prop}
The lattice of Cauchy spaces (on some set) is a complete sublattice of the lattice of low spaces whose graphs are almost sub-join-semilattices.
\end{prop}
