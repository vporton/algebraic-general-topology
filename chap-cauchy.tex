...
Thus they preserve joins of (completely) almost sub-join spaces and meets of symmetrically transitive reloids (and hence of uniform spaces).
\fxwarning{Check that $(\mathsf{RLD})_{\Low}f$ is a uniform space.}
