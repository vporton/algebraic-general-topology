...
\fxwarning{Rename ``low spaces'' either into ``filter spaces'' following
\url{http://link.springer.com/article/10.1007/s10474-011-0136-9} (``A note on Cauchy spaces'') or into ``precauchy spaces'' following
...
the category of filter merotopic spaces (what is it?)
WRONG: Precauchy space is necessarily reflexive while low space is not.}
