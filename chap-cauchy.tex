...
??Let $\nu$ be a lower bound of~$S$. It remains to prove that $\GR\mu\supseteq\GR\nu$, that is
$\bigsqcap\im P\in\GR\nu$ for every $P\in\prod_{X\in S}\GR X$.
Really: $P(X)\in\GR X$, $\im P\subseteq\GR X$


$\im P\subseteq\rsupfun{\GR}S$ and thus $\bigsqcap\im P\sqsupseteq\bigsqcap\rsupfun{\GR}S$
