...
\fxwarning{Two following definitions should be split into two, by one enumerated item in each.}
...
\fxnote{It seems however that transitivity makes sense for special cases such as Cauchy spaces.}
\end{rem}
