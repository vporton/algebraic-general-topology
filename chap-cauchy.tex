...
\begin{defn}
  $\PR \left( U ; \mathscr{C} \right) = \mathscr{C}$; $\Ob \left(
  U ; \mathscr{C} \right) = U$.\footnote{$\PR$ is from English word
  \emph{profile}.}
\end{defn}
...
\begin{proof}
  ...
  $\mathcal{X} \in \PR (\Low) (\mathsf{RLD})_{\Low}
...
\fxnote{Is composition of two images of low filter spaces also a low filters space?}
...
\begin{prop}
  Let $f$ is a principal reloid. Then $f \in \mathrm{C} \left( 
