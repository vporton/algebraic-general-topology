...
\begin{description}
 ...
 \item[\ref{omeq-flt}$\Rightarrow$\ref{omeq-res}] Proposition~\bookref{coat}.
\end{description}
\end{proof}
...
\begin{proof}
  ...
  \text{(corollary~\bookref{f-meet-closed})} \Leftrightarrow \forall S \in \subsets_{\operatorname{fin}}
...
\text{(theorem~\bookref{f-cor-max})} \sqsubseteq
\mathcal{Y}$.
...
\begin{enumerate}
 ...
 \item[\ref{corom-cond}$\Rightarrow$\ref{corom-res}]
  Theorems~\ref{cor-adjom} and~\bookref{cobrow}.
\end{enumerate}
\end{proof}
