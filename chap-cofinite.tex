...
\Leftrightarrow
\atoms^{\mathfrak{A}}\mathcal{X} \sqsubseteq \atoms^{\mathfrak{A}}\Omega_{1c} \cup \atoms^{\mathfrak{A}}\mathcal{Y}$;
...
\begin{thm}
$\Cor'$ is the lower adjoint of $\Omega\sqcup^{\mathfrak{A}}$
where $\Omega = \Omega_{1a} = \Omega_{1c}$,
provided that
  \begin{enumerate}
    \item $\mathfrak{A}$ is a join-semilattice.
    \item $\Cor'$ is defined on all~$\mathfrak{A}$.
