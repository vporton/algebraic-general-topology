...
\begin{prop}
A funcoid~$\nu$ is normally reloidazable iff there exists a funcoid~$t$ such that
$\nu\circ\nu^{-1}\sqsubseteq\nu^{-1}\circ t$.
\end{prop}

\begin{proof}
Because $\tofcd$ is an isomorphism from funcoidal reloids to funcoids.
\end{proof}

\begin{prop}
A funcoid~$\nu$ is normally quasi-uniformizable iff there exists a quasi-proximity space (=~reflexive and transitive funcoid)~$t$ such that
$\nu\circ\nu^{-1}\sqsubseteq\nu^{-1}\circ t$.
\end{prop}

\begin{proof}
Evidently $\tofcd$ is an isomorphism from reflexive and transitive funcoidal reloids to reflexive and transitive funcoids.
\end{proof}

\begin{prop}
The condition for normal quasi-uniformizability is equivalent to $\nu^{\circ} \circ \nu \circ \nu^{- 1} \sqsubseteq t$.
\end{prop}

\begin{proof}
$\nu \circ \nu^{- 1} \sqsubseteq \nu^{- 1} \circ t \Leftrightarrow \nu^{\circ} \circ \nu \circ \nu^{- 1} \sqsubseteq t$.
\end{proof}

\begin{cor}
Every funcoid is normally quasi-uniformizable. \fxerror{Wrong result! Where is the error?}
\end{cor}

\begin{proof}
Take $t=\top$ (it is a proximity space).
\end{proof}
