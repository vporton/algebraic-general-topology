...
\begin{proof}
  ...
  $\mathcal{X} = \langle U_{\mathcal{X}} \rangle A$, $Y = \langle
  U_{\mathcal{Y}} \rangle A$. Because $\mu$ is complete, we have
...
\begin{cor}\label{disj-mu}
  ...
  \up \mu$ such that $\supfun{U} A \asymp \supfun{U}
  B$.
\end{cor}

\begin{proof}
  Applying the lemma two times we can obtain $P, Q \in \up \mu$
  such that $\langle P \rangle A \asymp \langle Q \rangle B$. But because
  $\mu$ is complete, we have $U = P \sqcap Q \in \up \mu$,
  while obviously $\supfun{U} A \asymp \supfun{U} B$.
\end{proof}
