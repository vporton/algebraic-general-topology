\documentclass[english,reqno,12pt]{amsart}
...
%  {hyperref}
\hypersetup{pdftitle={Algebraic General Topology. Spaces are ordered semigroup actions},
...
It is a continuation of discoveries from~\cite{volume-1-edition1}.
