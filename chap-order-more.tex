...
\begin{defn}
\index{separable}\index{poset!separable}I call separable such poset
...
$a\sqsubseteq b\sqcup z\Rightarrow a\sqsubseteq(b\sqcup z)\sqcap a\Leftrightarrow a\sqsubseteq(b\sqcap a)\sqcup(z\sqcap a)\Leftrightarrow(b\sqcap a)\sqcup z'\Rightarrow a\sqsubseteq b\sqcap z'$
...
is defined. $z'$ is a lower bound for $\setcond{z\in\atoms a}{x\sqcap b=\bot}$ 
...
\end{defn}
I will denote lattice operations on a $\Mor$-set $C(A;B)$ of a category
...
inverse of $f$.
\end{proof}
Let $\Mor$-sets be complete lattices.
\begin{defn}
...
whenever $G$ is a set of morphisms with a suitable domain and image.
\end{defn}
Let now $\Mor$-sets be meet-semilattices.
\begin{defn}
...
whenever $g$ and $h$ are morphisms with a suitable domain and image.
\end{defn}
Let now $\Mor$-sets be join-semilattices.
\begin{defn}
