...
\[
g\circ f=\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}(G\circ F)}{F\in\up f,G\in\up g}.
\]
\end{defn}
\begin{obvious}
...
\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}(F\circ G)}{F\in\up f,G\in\up g}\sqcup\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}(F\circ H)}{F\in\up f,H\in\up h} & =\\
\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}(F_{1}\circ G)\sqcup\uparrow^{\mathsf{RLD}}(F_{2}\circ H)}{F_{1},F_{2}\in\up f,G\in\up g,H\in\up h} & =\\
\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}((F_{1}\circ G)\sqcup(F_{2}\circ H))}{F_{1},F_{2}\in\up f,G\in\up g,H\in\up h}.
\end{align*}


Obviously
\begin{align*}
\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}((F_{1}\circ G)\sqcup(F_{2}\circ H))}{F_{1},F_{2}\in\up f,G\in\up g,H\in\up h} & \sqsupseteq\\
\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}(((F_{1}\sqcap F_{2})\circ G)\sqcup((F_{1}\sqcap F_{2})\circ H))}{F_{1},F_{2}\in\up f,G\in\up g,H\in\up h} & =\\
\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}((F\circ G)\sqcup(F\circ H))}{F\in\up f,G\in\up g,H\in\up h} & =\\
\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}(F\circ(G\sqcup H))}{F\in\up f,G\in\up g,H\in\up h}.
\end{align*}
...
we have
\begin{align*}
\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}(F\circ(G\sqcup H))}{F\in\up f,G\in\up g,H\in\up h} & \sqsupseteq\\
\bigsqcap\setcond{\uparrow^{\mathsf{RLD}}(F\circ K)}{F\in\up f,K\in\up(g\sqcup h)} & =\\
f\circ(g\sqcup h).
\end{align*}
...
\end{proof}
\begin{align*}
\bigsqcup\setcond{g\circ F}{F\in\atoms f}=g\circ f & \Leftrightarrow\\
\forall x\in\mathsf{RLD}(\Src f;\Dst g):\left(x\nasymp g\circ f\Leftrightarrow x\nasymp\bigsqcup\setcond{g\circ F}{F\in\atoms f}\right) & \Leftarrow\\
\forall x\in\mathsf{RLD}(\Src f;\Dst g):\left(x\nasymp g\circ f\Leftrightarrow\exists F\in\atoms f:x\nasymp g\circ F\right) & \Leftrightarrow\\
\forall x\in\mathsf{RLD}(\Src f;\Dst g):(g^{-1}\circ x\nasymp f\Leftrightarrow\exists F\in\atoms f:g^{-1}\circ x\nasymp F)
\end{align*}
...
~
\begin{align*}
\up((\mathcal{A}_{0}\times^{\mathsf{RLD}}\mathcal{B}_{0})\sqcap(\mathcal{A}_{1}\times^{\mathsf{RLD}}\mathcal{B}_{1})) & =\\
\setcond{P\sqcap Q}{P\in\up(\mathcal{A}_{0}\times^{\mathsf{RLD}}\mathcal{B}_{0}),Q\in\up(\mathcal{A}_{1}\times^{\mathsf{RLD}}\mathcal{B}_{1})} & =\\
\setcond{(A_{0}\times B_{0})\cap(A_{1}\times B_{1})}{A_{0}\in\up\mathcal{A}_{0},B_{0}\in\up\mathcal{B}_{0},A_{1}\in\up\mathcal{A}_{1},B_{1}\in\up\mathcal{B}_{1}} & =\\
\setcond{(A_{0}\cap A_{1})\times(B_{0}\times B_{1})}{A_{0}\in\up\mathcal{A}_{0},B_{0}\in\up\mathcal{B}_{0},A_{1}\in\up\mathcal{A}_{1},B_{1}\in\up\mathcal{B}_{1}} & =\\
\setcond{K\times L}{K\in\up(\mathcal{A}_{0}\sqcap\mathcal{A}_{1}),L\in\up(\mathcal{B}_{0}\sqcap\mathcal{B}_{1})} & =\\
\up((\mathcal{A}_{0}\sqcap\mathcal{A}_{1})\times^{\mathsf{RLD}}(\mathcal{B}_{0}\sqcap\mathcal{B}_{1})).
\end{align*}
\end{proof}
\begin{thm}
...
\uparrow^{\mathsf{RLD}(\Base(\mathcal{A});\Base(\mathcal{A}))}\id_{\Base(\mathcal{A})}\sqcap\uparrow^{\mathsf{RLD}}(A\times\top^{\mathscr{F}(\Base(\mathcal{A}))}) & =\\
...
\[
f\sqcap(\mathcal{A}\times^{\mathsf{RLD}}\top^{\mathscr{F}(\Dst f)})=f\circ\bigsqcap\setcond{\uparrow^{\mathsf{RLD}(\Src f;\Src f)}\id_{A}}{A\in\up\mathcal{A}}.
\]
...
(\id_{\mathcal{A}}^{\mathsf{\mathsf{RLD}}}\circ f\circ\id_{\mathcal{B}}^{\mathsf{\mathsf{RLD}}})^{-1} & =\\
\id_{\mathcal{B}}^{\mathsf{\mathsf{RLD}}}\circ f\circ\id_{\mathcal{A}}^{\mathsf{\mathsf{RLD}}}.
\end{align*}
\end{proof}
\begin{thm}
$f|_{\uparrow^{\Src f}\{\alpha\}}=\uparrow^{\Src f}\{\alpha\}\times^{\mathsf{RLD}}\im(f|_{\uparrow^{\Src f}\{\alpha\}})$
for every reloid $f$ and $\alpha\in\Src f$.\end{thm}
\begin{proof}
First,
\begin{align*}
\im(f|_{\uparrow^{\Src f}\{\alpha\}}) & =\\
\bigsqcap^{\mathsf{RLD}}\rsupfun{\im}\up(f|_{\uparrow^{\Src f}\{\alpha\}}) & =\\
\bigsqcap^{\mathsf{RLD}}\rsupfun{\im}\up(f\sqcap(\uparrow^{\Src f}\{\alpha\}\times\top^{\mathscr{F}(\Dst f)})) & =\\
\bigsqcap^{\mathsf{RLD}}\setcond{\im(F\cap(\{\alpha\}\times\Dst f))}{F\in\up f} & =\\
\bigsqcap^{\mathsf{RLD}}\setcond{\im(F|_{\{\alpha\}})}{F\in\up f}.
\end{align*}


Taking this into account we have:
\begin{align*}
\uparrow^{\Src f}\{\alpha\}\times^{\mathsf{RLD}}\im(f|_{\uparrow^{\Src f}\{\alpha\}}) & =\\
\bigsqcap^{\mathsf{RLD}}\setcond{\uparrow^{\Src f}\{\alpha\}\times K}{K\in\im(f|_{\uparrow^{\Src f}\{\alpha\}})} & =\\
\bigsqcap^{\mathsf{RLD}}\setcond{\uparrow^{\Src f}\{\alpha\}\times\im(F|_{\uparrow^{\Src f}\{\alpha\}})}{F\in\up f} & =\\
\bigsqcap^{\mathsf{RLD}}\setcond{F|_{\uparrow^{\Src f}\{\alpha\}}}{F\in\up f} & =\\
\bigsqcap^{\mathsf{RLD}}\setcond{F\cap(\uparrow^{\Src f}\{\alpha\}\times\top^{\mathscr{T}(\Dst f)})}{F\in\up f} & =\\
...
\begin{proof}
We need to prove $\im f\sqsubseteq\mathcal{B}\Leftrightarrow\top^{\mathscr{F}}\times^{\mathsf{RLD}}\mathcal{B}$
...
The inverse isomorphism is described by the formula $G(\alpha)=\im(f|_{\uparrow^{A}\{\alpha\}})$
...
\]
is complete. So $G\mapsto\bigsqcup\setcond{\uparrow^{A}\{\alpha\}\times^{\mathsf{FCD}}G(\alpha)}{\alpha\in A}$
...
$\beta\in\Src f$.
\begin{align*}
f\sqcap(\uparrow^{A}\{\beta\}\times^{\mathsf{RLD}}\top^{\mathscr{F}(B)}) & =\text{ (proposition \ref{b-f-back-distr})}\\
...
Then
\begin{multline*}
\im(f|_{\uparrow^{A}\{\alpha\}})=\im(f\sqcap(\uparrow^{A}\{\alpha'\}\times\top^{\mathscr{T}(B)}))=\text{(because \ensuremath{\uparrow^{A}\{\alpha'\}\times\top^{\mathscr{T}(B)}} is principal)}=\\
...
The inverse isomorphism is described by the formula $G(\alpha)=\im(f^{-1}|_{\uparrow^{A}\{\alpha\}})$
where $f$ is a co-complete reloid.
\end{cor}

\begin{cor}
The inverse isomorphism is described by the formula $G(\alpha)=\im(f|_{\uparrow^{A}\{\alpha\}})$
where $f$ is a complete reloid.
...
\begin{cor}
$\mathsf{ComplRLD}$ (with the induced order) is a complete lattice.\end{cor}
\begin{thm}
...
\[
\Compl f=\Cor^{(\mathsf{RLD}(A;B);\mathsf{ComplRLD}(A;B))}f;\quad\CoCompl f=\Cor^{(\mathsf{RLD}(A;B);\mathsf{CoComplRLD}(A;B))}f.
\]
\end{defn}
\begin{thm}
...
\begin{prop}
$\Compl f=\bigsqcup\setcond{f|_{\uparrow^{\Src f}\{\alpha\}}}{\alpha\in\Src f}$
...
We have $\uparrow^{\Src f}\{\alpha\}\times^{\mathsf{RLD}}G(\alpha)=g|_{\uparrow^{\Src f}\{\alpha\}}\sqsubseteq f|_{\uparrow^{\Src f}\{\alpha\}}$.
...
\bigsqcup\setcond{\bigsqcup\setcond{f|_{\uparrow^{A}\{\alpha\}}}{\alpha\in A}}{f\in R} & =\\
...
\begin{align*}
\Compl f & =\\
\bigsqcup\setcond{\left(\bigsqcup\setcond{F(\alpha)\times^{\mathsf{RLD}}\uparrow^{\Dst f}\{\alpha\}}{\alpha\in\Dst f}\right)|_{\uparrow^{\Src f}\{\beta\}}}{\beta\in\Src f} & =\\
