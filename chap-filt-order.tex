...
\begin{prop}
$\supfun{\uparrow^{\mathsf{FCD}}f}\mathcal{A}=\setcond{C\in\mathscr{T}(\Dst f)}{\rsupfun{f^{-1}}C\in\mathcal{A}}$
...
\end{align*}
So $C\in \setcond{C\in\mathscr{T}(\Dst f)}{\rsupfun{f^{-1}}C\in\mathcal{A}}\Rightarrow C\in\supfun{\uparrow^{\mathsf{FCD}}f}\mathcal{A}$.
