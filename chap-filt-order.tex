...
\emph{and $\subsets X\cap\mathcal{A}=\subsets X\cap\mathcal{B}$.}\end{defn}
\begin{prop}
...
\end{align*}
So $C\in f\ast\mathcal{A}\Rightarrow C\in\supfun{\uparrow^{\mathsf{FCD}}f}\mathcal{A}$.

Let now $C\in\supfun{\uparrow^{\mathsf{FCD}}f}\mathcal{A}$. Then
$\uparrow^{\Base(\mathcal{A})}\rsupfun{f^{-1}}C\sqsupseteq\supfun{\uparrow^{\mathsf{FCD}}f^{-1}}\supfun{\uparrow^{\mathsf{FCD}}f}\mathcal{A}\sqsupseteq\mathcal{A}$
...
to $\Base(\mathcal{B})$ such that $\mathcal{B}\supseteq\supfun{\uparrow^{\mathsf{FCD}}f}\mathcal{A}$.
\end{defn}
...
\begin{defn}
Let $\mathcal{A}$ be a filter on a set $X$ and $\mathcal{B}$ is
a filter on a set $Y$. $\mathcal{A}\ge_{1}\mathcal{B}$ iff $\Mor_{\mathbf{GreFunc}_{1}}(\mathcal{A};\mathcal{B})$
is not empty.
\end{defn}

\begin{defn}
Let $\mathcal{A}$ be a filter on a set $X$ and $\mathcal{B}$ is
a filter on a set $Y$. $\mathcal{A}\ge_{2}\mathcal{B}$ iff $\Mor_{\mathbf{GreFunc}_{2}}(\mathcal{A};\mathcal{B})$
is not empty.\end{defn}
\begin{prop}
~
\begin{enumerate}
\item \label{gre-imp}$f\in\Mor_{\mathbf{GreFunc}_{1}}(\mathcal{A};\mathcal{B})$
...
\item \label{gre-eq}$f\in\Mor_{\mathbf{GreFunc}_{2}}(\mathcal{A};\mathcal{B})$
iff $f$ is a $\mathbf{Set}$-morphism from $\Base(\mathcal{A})$
to $\Base(\mathcal{B})$ such that
\[
...
\item [{\ref{gre-imp}}] ~
\begin{multline*}
f\in\Mor_{\mathbf{GreFunc}_{1}}(\mathcal{A};\mathcal{B})\Leftrightarrow\mathcal{B}\supseteq\supfun{\uparrow^{\mathsf{FCD}}f}\mathcal{A}\Leftrightarrow\\
...
\item [{\ref{gre-eq}}] ~
\begin{multline*}
f\in\Mor_{\mathbf{GreFunc}_{2}}(\mathcal{A};\mathcal{B})\Leftrightarrow\mathcal{B}=\supfun{\uparrow^{\mathsf{FCD}}f}\mathcal{A}\Leftrightarrow\forall C:(C\in\mathcal{B}\Leftrightarrow C\in\supfun{\uparrow^{\mathsf{FCD}}f}\mathcal{A})\Leftrightarrow\\
...
isomorphic} to a filter $\mathcal{B}$ iff there is a morphism $f\in\Mor_{\mathbf{FuncBij}}(\mathcal{A};\mathcal{B})$.\end{defn}
\begin{cor}
$f\in\Mor_{\mathbf{GreFunc}_{1}}(\mathcal{A};\mathcal{B})\Leftrightarrow\mathcal{B}\sqsubseteq\supfun{\uparrow^{\mathsf{FCD}}f}\mathcal{A}$
for every $\mathbf{Set}$-morphism from $\Base(\mathcal{A})$ to $\Base(\mathcal{B})$.
\end{cor}

\begin{cor}
$f\in\Mor_{\mathbf{GreFunc}_{2}}(\mathcal{A};\mathcal{B})\Leftrightarrow\mathcal{B}=\supfun{\uparrow^{\mathsf{FCD}}f}\mathcal{A}$
for every $\mathbf{Set}$-morphism from $\Base(\mathcal{A})$ to $\Base(\mathcal{B})$.
\end{cor}
...
\begin{enumerate}
\item \label{fbij-star}$\mathcal{B}=f\ast\mathcal{A}$.
...
\item \label{fbij-gre}$f\in\Mor_{\mathbf{GreFunc}_{2}}(\mathcal{A};\mathcal{B})$.
\item \label{fbij-grp}$f\in\Mor_{\mathbf{FuncBij}}(\mathcal{A};\mathcal{B})$.
\end{enumerate}
\end{prop}
\begin{proof}
~
...
\begin{multline*}
\mathcal{B}=f\ast\mathcal{A}\Leftrightarrow\mathcal{B}=\setcond{C\in\subsets\Base(\mathcal{B})}{\rsupfun{f^{-1}}C\in\mathcal{A}}\Leftrightarrow\\
...
\item [{\ref{fbij-rbij}$\Rightarrow$\ref{fbij-eforw}}] We have $\forall C\in\Base(\mathcal{A}):((\supfun{\uparrow^{\mathsf{FCD}}f}|_{\mathcal{A}})C\Leftrightarrow C\in\mathcal{A})$
...
\item There is a bijective morphism $f\in\Mor_{\mathbf{GreFunc}_{2}}(\mathcal{A};\mathcal{B})$.
\end{enumerate}
\end{cor}
\begin{prop}
...
It remains to prove only that every morphism $f\in\Mor_{\mathbf{FuncBij}}(\mathcal{A};\mathcal{B})$
...
\]
 Thus $f^{-1}\in\Mor_{\mathbf{FuncBij}}(\mathcal{B};\mathcal{A})$.\end{proof}
\begin{cor}
...
\item \label{ge1-eq-ge}$\Mor_{\mathbf{MonRld}_{=,\sqsupseteq}}(\mathcal{A};\mathcal{B})\ne\emptyset$.
\item \label{ge1-le-ge}$\Mor_{\mathbf{MonRld}_{\sqsubseteq,\sqsupseteq}}(\mathcal{A};\mathcal{B})\ne\emptyset$.
\item \label{ge1-le-eq}$\Mor_{\mathbf{MonRld}_{\sqsubseteq,=}}(\mathcal{A};\mathcal{B})\ne\emptyset$.
\item \label{g1-c-eq-ge}$\Mor_{\mathbf{CoMonRld}_{=,\sqsupseteq}}(\mathcal{A};\mathcal{B})\ne\emptyset$.
\item \label{g1-c-le-ge}$\Mor_{\mathbf{CoMonRld}_{\sqsubseteq,\sqsupseteq}}(\mathcal{A};\mathcal{B})\ne\emptyset$.
\item \label{g1-c-le-eq}$\Mor_{\mathbf{CoMonRld}_{\sqsubseteq,=}}(\mathcal{A};\mathcal{B})\ne\emptyset$.
\end{enumerate}
\end{thm}
\begin{proof}
~
...
\item \label{ge2-mon}$\Mor_{\mathbf{MonRld}_{=,=}}(\mathcal{A};\mathcal{B})\ne\emptyset$.
\item \label{ge2-comon}$\Mor_{\mathbf{CoMonRld}_{=,=}}(\mathcal{A};\mathcal{B})\ne\emptyset$.
\end{enumerate}
\end{thm}
\begin{proof}
~
...
We have:
\begin{widedisorder}
\item [{\ref{monrld-le-ge}}] Let $f\in\Mor_{\mathbf{MonRld}_{\sqsubseteq,\sqsupseteq}}(\mathcal{A};\mathcal{B})$,
$g\in\Mor_{\mathbf{MonRld}_{\sqsubseteq,\sqsupseteq}}(\mathcal{B};\mathcal{C})$.
...
that is $g\circ f\in\Mor_{\mathbf{MonRld}_{\sqsubseteq,\sqsupseteq}}(\mathcal{A};\mathcal{C})$.
\item [{\ref{monrld-le-eq}}] Let $f\in\Mor_{\mathbf{MonRld}_{\sqsubseteq,=}}(\mathcal{A};\mathcal{B})$,
$g\in\Mor_{\mathbf{MonRld}_{\sqsubseteq,=}}(\mathcal{B};\mathcal{C})$.
...
$\im(g\circ f)=\mathcal{C}$ that is $g\circ f\in\Mor_{\mathbf{MonRld}_{\sqsubseteq,=}}(\mathcal{A};\mathcal{C})$.
\item [{\ref{monrld-eq-eq}}] Let $f\in\Mor_{\mathbf{MonRld}_{=,=}}(\mathcal{A};\mathcal{B})$,
$g\in\Mor_{\mathbf{MonRld}_{=,=}}(\mathcal{B};\mathcal{C})$. Then
$\dom f=\mathcal{A}$, $\im f=\mathcal{B}$, $\dom g=\mathcal{B}$,
$\im g=\mathcal{C}$. So $\dom(g\circ f)=\mathcal{A}$, $\im(g\circ f)=\mathcal{C}$
that is $g\circ f\in\Mor_{\mathbf{MonRld}_{=,=}}(\mathcal{A};\mathcal{C})$.
\end{widedisorder}
\end{proof}
\begin{defn}
...
\begin{thm}
Filters $\mathcal{A}$ and $\mathcal{B}$ are isomorphic iff $\Mor_{\mathbf{BijRld}}(\mathcal{A};\mathcal{B})\neq\emptyset$.\end{thm}
\begin{proof}
~
\begin{description}
...
\begin{align*}
\im f & =\\
\bigsqcap\setcond{\uparrow^{B}\im G}{G\in(\uparrow^{\mathsf{RLD}}F)|_{\mathcal{A}}} & =\\
\bigsqcap\setcond{\uparrow^{B}\im(H\cap F|_{X})}{H\in(\uparrow^{\mathsf{RLD}}F)|_{\mathcal{A}},X\in\mathcal{A}} & =\\
\bigsqcap\setcond{\uparrow^{B}\im F|_{P}}{P\in\mathcal{A}} & =\\
\bigsqcap\setcond{\uparrow^{B}\rsupfun FP}{P\in\mathcal{A}} & =\\
\bigsqcap\setcond{\uparrow^{B}\rsupfun FP}{P\in\subsets A\cap\mathcal{A}} & =\\
\bigsqcap\rsupfun{\uparrow^{B}}(\subsets B\cap\mathcal{B}) & =\\
\bigsqcap\rsupfun{\uparrow^{B}}\mathcal{B}=\mathcal{B}.
\end{align*}
...
(\uparrow^{\mathsf{RLD}(\Src f;\Dst f)}(F\cap G))|_{\dom f}.
\end{multline*}
Obviously $F\cap G$ is an injection.\end{proof}
\begin{thm}
...
$\mathcal{A}\eqdef\bigsqcup_{n\in\mathbb{Z}}(\uparrow^{\mathbb{Z}}\{n\}\times u_{2n+1})$;
$\mathcal{B}\eqdef\bigsqcup_{n\in\mathbb{Z}}(\uparrow^{\mathbb{Z}}\{n\}\times u_{2n})$.
...
\bigsqcup\rsupfun{\supfun{\uparrow^{\mathsf{FCD}}f}}\setcond{\uparrow^{\mathbb{Z}}\{n\}\times u_{2n+1}}{n\in\mathbb{Z}} & =\\
\bigsqcup\setcond{\uparrow^{\mathbb{Z}}\{n\}\times u_{2n}}{n\in\mathbb{Z}} & =\\
\mathcal{B}.\\
\supfun{\uparrow^{\mathsf{FCD}}f}\mathcal{B} & =\\
\bigsqcup\rsupfun{\supfun{\uparrow^{\mathsf{FCD}}f}}\setcond{\uparrow^{\mathbb{Z}}\{n\}\times u_{2n}}{n\in\mathbb{Z}} & =\\
\bigsqcup\rsupfun{\supfun{\uparrow^{\mathsf{FCD}}f}}\setcond{\uparrow^{\mathbb{Z}}\{n-1\}\times u_{2n-1}}{n\in\mathbb{Z}} & =\\
\bigsqcup\setcond{\uparrow^{\mathbb{Z}}\{n\}\times u_{2n+1}}{n\in\mathbb{Z}} & =\\
\mathcal{A}.
\end{align*}
...
Let $X\in\uparrow^{\mathbb{Z}}\{n\}\times^{\mathsf{RLD}}u_{2n+1}$
...
If $X\notin\uparrow^{\mathbb{Z}}\{n\}\times^{\mathsf{RLD}}u_{2n+1}$
for every $n\in\mathbb{Z}$ then $(\mathbb{Z}\times\mathbb{N})\setminus X\in\uparrow^{\mathbb{Z}}\{n\}\times^{\mathsf{RLD}}u_{2n+1}$
and thus $(\mathbb{Z}\times\mathbb{N})\setminus X\in\mathcal{A}$
and thus $\uparrow^{\mathbb{Z}\times\mathbb{N}}X\sqcap\mathcal{A}=\bot^{\mathbb{Z}\times\mathbb{N}}$.

We have also
\begin{multline*}
(\uparrow^{\mathbb{Z}}\{0\}\times^{\mathsf{RLD}}\mathbb{N})\sqcap\mathcal{B}=(\uparrow^{\mathbb{Z}}\{0\}\times^{\mathsf{RLD}}\mathbb{N})\sqcap\bigsqcup\setcond{\uparrow^{\mathbb{Z}}\{n\}\times u_{2n}}{n\in\mathbb{Z}}=\\
\bigsqcup\setcond{(\uparrow^{\mathbb{Z}}\{0\}\times^{\mathsf{RLD}}\mathbb{N})\sqcap(\uparrow^{\mathbb{Z}}\{n\}\times u_{2n})}{n\in\mathbb{Z}}=\uparrow^{\mathbb{Z}}\{0\}\times^{\mathsf{RLD}}u_{0}\text{ (an ultrafilter).}
\end{multline*}
