...
\begin{proof}
First prove that $\setcond{ X \in \subsets A }
{\exists Y \in \mathcal{A} : Y\cap A \subseteq X }$ is a filter. That it is an upper set is obvious. Let
$P,Q\in\setcond{ X \in \subsets A }
{\exists Y \in \mathcal{A} : Y\cap A \subseteq X }$ that is
$\exists Y_0 \in \mathcal{A} : Y\cap A \subseteq P$ and
$\exists Y_1 \in \mathcal{A} : Y\cap A \subseteq Q$. So
we have $(Y_0\cap Y_1)\cap A\subseteq P\cap Q$ and thus
$\exists Y \in \mathcal{A} : Y\cap A \subseteq P\cap Q$.
Thus $P\cap Q\in\setcond{ X \in \subsets A }
...
\end{proof}
\begin{prop}
\fxwarning{A more general proposition proved, remove this.}
