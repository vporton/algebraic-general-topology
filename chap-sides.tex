...
\begin{prop}
The category of funcoids with usual~$\supfun{f}$ defines a system of sides with correct identities.
\end{prop}
...
\begin{prop}
Reloids with the functor $f\mapsto\supfun{\tofcd f}$ form a system of sides with correct identities.
\end{prop}
