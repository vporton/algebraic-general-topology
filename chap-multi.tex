...
$X_{0}$ contains all but binarily many elements of $\mathbb{N}$.
...
such that either $p(n)\supseteq A$ for all but binarily many $n$
or $p(n)\supseteq B$ for all but binarily many $n$. Let's prove
...
$L(n)\supseteq A$ for all but binarily many $n$ or $L(n)\supseteq B$
for all but binarily many $n$; $L\cup\{(k;x)\}\in\GR f$ iff $x\in a$
and $L(n)\supseteq A$ for all but binarily many $n$ or $L(n)\supseteq B$;
and similarly for $y$.
