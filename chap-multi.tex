...
\begin{prop}
$\uparrow^{\mathsf{Strd}}\id_{A[n]}\sqsupseteq\downdownarrows\ID_{\uparrow A[n]}^{\mathsf{Strd}}$
...
\end{proof}
\begin{prop}
$\uparrow^{\mathsf{Strd}}\id_{A[n]}\sqsupset\downdownarrows\ID_{\uparrow A[n]}^{\mathsf{Strd}}$
