...
is not a completary staroid. This also proves existence of completary staroids (but not on powersets).\end{example}
\begin{proof}
...
Thus $f$ is the graph of a staroid of the form $\mylamdba{i}{\mathbb{N}}{\subsets\mathbb{N}}$ (on powersets).
