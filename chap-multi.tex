...
\exists x\in\atoms\uparrow^{\mathsf{RLD}(\mylambda i{\dom f}{\Src f_{i}})}X,y\in\atoms\uparrow^{\mathsf{RLD}(\mylambda i{\dom f}{\Dst f_{i}})}Y:a\suprel{\prod^{(A)}f}b\Rightarrow\\
a\suprel{\prod^{(A)}f}b.
\end{multline*}
...
\begin{multline*}
\forall X\in\GR a,Y\in\GR b\\
\exists x\in\atoms\uparrow^{\mathsf{RLD}(\mylambda i{\dom f}{\Src f_{i}})}X,y\in\atoms\uparrow^{\mathsf{RLD}(\mylambda i{\dom f}{\Dst f_{i}})}Y:a\suprel{\prod^{(A)}f}b.
\end{multline*}
