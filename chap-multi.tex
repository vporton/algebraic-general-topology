...
$K\supseteq\prod X$ and thus $K\supseteq\bigcup_{X\in\prod_{i\in\dom a}\atoms a}\prod X$
for some $X\in\prod_{i\in\dom a}\atoms a$.

But $\bigcup_{X\in\prod_{i\in\dom a}\atoms a}\prod X=\prod_{i\in\dom A}\bigcup\rsupfun{\Pr_{i}}X\supseteq\prod_{j\in\dom A}Z_{j}$
