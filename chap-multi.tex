...
\end{equation}
I denote the set of multifuncoids for a family~$\mathfrak{A}$ of filtrators as $\mathsf{pFCD}(\mathfrak{A})$.
\end{defn}
...
\end{proof}
\begin{defn}
I will denote $\rsuprel{f}=\rsuprel{g}$ for the prestaroidal mult~$f$ corresponding to multifuncoid~$f$.
\end{defn}
