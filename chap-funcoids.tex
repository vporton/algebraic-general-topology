...
\begin{proof}
  ...
  \up a = \bigsqcap \left\langle \bigsqcup \circ \rsupfun{
  \alpha } \circ \atoms \circ (\Omega \sqcap)
  \right\rangle^{\ast} \up a =
  \bigsqcap \setcond{ \bigsqcup \langle \alpha \rangle^{\ast} \atoms (\Omega \sqcap X) }{ X \in \up a } =
  \bigsqcap \setcond{ \bigsqcup \langle \langle
  f \rangle \rangle^{\ast} \atoms (\Omega \sqcap X) }{ X \in \up a } \sqsupseteq
