...
and
\begin{align*}
\lnot(I & \rsuprel f\bot^{\mathscr{T}(B)}), & I\sqcup J\rsuprel fK & \Leftrightarrow I\rsuprel fK\lor J\rsuprel fK & \text{(for every \ensuremath{I,J\in\mathscr{T}A}, \ensuremath{K\in\mathscr{T}B})},\\
\lnot(\bot^{\mathscr{T}(A)} & \rsuprel fI), & K\rsuprel fI\sqcup J & \Leftrightarrow K\rsuprel fI\lor K\rsuprel fJ & \text{(for every \ensuremath{I,J\in\mathscr{T}B}, \ensuremath{K\in\mathscr{T}A})}.
\end{align*}
\end{prop}
\begin{proof}
...
$I\rsuprel f\bot^{\mathscr{T}(B)}\Leftrightarrow\bot^{\mathscr{F}(B)}\nasymp\supfun f\uparrow I\Leftrightarrow0$;
\begin{align*}
...
\begin{equation}
\supfun{L_{F}^{-1}\alpha}\mathcal{X}=\bigsqcap\rsupfun{\alpha}\up\mathcal{X}.\label{fchar-alph-c}
\end{equation}
...
\]
is a generalized filter base: To prove it is enough to show that $\rsupfun{\alpha}\up\mathcal{X}$
