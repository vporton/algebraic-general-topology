...
\begin{proof}
  Suppose $h \in \up (\mathcal{A} \times^{\mathsf{RLD}}_F
  \mathcal{C})$ then $h \in \up (\mathcal{A}
  \times^{\mathsf{FCD}} \mathcal{C})$. Thus $h
  \mathrel{\not{\sqsupseteq}} g \circ f$ for every $f \in \up
  (\mathcal{A} \times^{\mathsf{RLD}}_F \mathcal{C})$, $g \in \up
  (\mathcal{B} \times^{\mathsf{RLD}}_F \mathcal{C})$. Thus $\up
  ((\mathcal{B} \times^{\mathsf{RLD}}_F \mathcal{C}) \circ (\mathcal{A}
  \times^{\mathsf{RLD}}_F \mathcal{B})) \neq \up (\mathcal{A}
