...
\begin{proof}
  ...
  \mathrel{\not{\sqsupseteq}} 1^{\mathsf{FCD}}$) and $\langle \mu
...
\begin{thm}
  If meet of two connected (regarding a funcoid) filters is nonempty, then
...
\begin{proof}
  ...
  But $a \mathrel{[\mu]} x$ follows?? \fxerror{no, it doesn't}
