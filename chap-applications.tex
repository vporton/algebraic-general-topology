...
$f\in\continuous(|A|_{>};|B|_{\geq})$.\fxwarning{Prove the second ``iff''!}
...
Let now moreover \fxwarning{Show that it is moreover.} $f\in\continuous(|A|_{>};|B|_{>})$. We need to prove that $f$ is strictly monotone.
