...
\begin{conjecture}
$\overrightarrow{\mathbb{R}}\circ\overleftarrow{\mathbb{R}}^{-1}$ is the usual (topology or proximity?) on~$\mathbb{R}$.
\end{conjecture}
...
$f\in\continuous(\overrightarrow{A}\circ\overleftarrow{A}^{-1};\overrightarrow{B}\circ\overleftarrow{B}^{-1})$, provided that $A$ is a connected set (=interval).
\end{conjecture}
...
Without lost of generality, prove just that it is locally monotone at~$0$. Suppose for the contrary
