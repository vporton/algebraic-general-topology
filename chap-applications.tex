...
\begin{lem}
Let function~$f:\Ob\mu\rightarrow\Ob\nu$ where
$\mu$,~$\nu$ are endofuncoids on subsets of~$\mathbb{R}$ and $\mu$~is connected.
\begin{enumerate}
\item $f$ is monotone and $f\in\continuous(\mu,\nu)$ iff
$f\in\continuous(\mu,\nu)\cap\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{\geq},\iota_{\Ob\nu}|\mathbb{R}|_{\geq})$ iff
$f\in\continuous(\mu,\nu)\cap\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{>},\iota_{\Ob\nu}|\mathbb{R}|_{\geq})$ iff
$f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{\geq},\iota_{\Ob\nu}|\mathbb{R}|_{\geq})\cap
\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{\leq},\iota_{\Ob\nu}|\mathbb{R}|_{\leq})$.
\item $f$ is strictly monotone and $\in\continuous(\mu,\nu)$ iff
$f\in\continuous(\mu,\nu)\cap\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{>},\iota_B|\mathbb{R}|_{>})$ iff
$f\in\continuous(\iota_A|\mathbb{R}|_{>},\iota_{\Ob\nu}|\mathbb{R}|_{>})\cap
\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{<},\iota_{\Ob\nu}|\mathbb{R}|_{<})$.
\end{enumerate}
...
\begin{proof}
Because $f$ is continuous, we have $\rsupfun{f\circ\iota_{\Ob\mu}|\mathbb{R}|}\{x\} \sqsubseteq \rsupfun{\iota_{\Ob\nu}|\mathbb{R}|\circ f}\{x\}$
...
$\rsupfun{f\circ \iota_{\Ob\mu}|\mathbb{R}|_{\geq}}\{x\} \sqsubseteq \rsupfun{\iota_{\Ob\nu}|\mathbb{R}|_{\geq}\circ f}\{x\}$, thus
$f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{\geq},\iota_{\Ob\nu}|\mathbb{R}|_{\geq})$.
...
$\rsupfun{f\circ \iota_{\Ob\mu}|\mathbb{R}|_{>}}\{x\} \sqsubseteq \rsupfun{\iota_{\Ob\nu}|\mathbb{R}|_{>}\circ f}\{x\}$, thus
$f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{>},\iota_{\Ob\nu}|\mathbb{R}|_{>})$.

Let now $f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{\geq},\iota_{\Ob\nu}|\mathbb{R}|_{\geq})$.

Take any~$a\in {\Ob\mu}$ and let $c=\setcond{b\in {\Ob\nu}}{b\geq a, \forall x\in[a;b[: f(x)\geq f(a)}$.
It's enough to prove that $c$ is the right endpoint (finite or infinite) of~${\Ob\mu}$.

Indeed by continuity $f(a)\leq f(c)$ and if $c$ is not already the right endpoint of~${\Ob\mu}$, then
there is $b'>c$ such that $\forall x\in[c;b'[: f(x)\geq f(c)$.
So we have $\forall x\in[a;b'[: f(x)\geq f(c)$ what contradicts to the above.

So $f$ is monotone on the entire~${\Ob\mu}$.

$f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{\geq},\iota_{\Ob\nu}|\mathbb{R}|_{\geq}) \Rightarrow f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{>},\iota_{\Ob\nu}|\mathbb{R}|_{\geq})$ is obvious. Reversely
$f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{>},\iota_{\Ob\nu}|\mathbb{R}|_{\geq}) \Rightarrow
f\circ \iota_{\Ob\mu}|\mathbb{R}|_{>} \sqsubseteq \iota_{\Ob\nu}|\mathbb{R}|_{\geq}\circ f \Leftrightarrow
\forall x\in\mathbb{R}: \supfun{f}\rsupfun{\iota_{\Ob\mu}|\mathbb{R}|_{>}}\{x\} \sqsubseteq \rsupfun{\iota_{\Ob\nu}|\mathbb{R}|_{\geq}}\rsupfun{f}\{x\} \Leftrightarrow
...
\forall x\in\mathbb{R}: \supfun{f}\rsupfun{\iota_{\Ob\mu}|\mathbb{R}|_{\geq}}\{x\} \sqsubseteq \rsupfun{\iota_{\Ob\nu}|\mathbb{R}|_{\geq}}\rsupfun{f}\{x\} \Leftrightarrow
\forall x\in\mathbb{R}: f\circ \iota_{\Ob\mu}|\mathbb{R}|_{\geq} \sqsubseteq \iota_{\Ob\nu}|\mathbb{R}|_{\geq}\circ f \Leftrightarrow
f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{\geq},\iota_{\Ob\nu}|\mathbb{R}|_{\geq})$.

Let $f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{>},\iota_{\Ob\nu}|\mathbb{R}|_{>})$. Then $f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{>},\iota_{\Ob\nu}|\mathbb{R}|_{\geq})$ and thus it is monotone.
We need to prove that $f$ is strictly monotone.
Suppose the contrary. Then there is a nonempty interval $[p;q]\subseteq {\Ob\mu}$ such that $f$ is constant on this interval.
But this is impossible because $f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{>},\iota_{\Ob\nu}|\mathbb{R}|_{>})$.

Prove that $f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{\geq},\iota_{\Ob\nu}|\mathbb{R}|_{\geq})\cap
\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{\leq},\iota_{\Ob\nu}|\mathbb{R}|_{\leq})$ implies
$f\in\continuous({\Ob\mu},{\Ob\nu})$. Really, it implies
...
Prove that $f\in\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{>},\iota_{\Ob\nu}|\mathbb{R}|_{>})\cap
\continuous(\iota_{\Ob\mu}|\mathbb{R}|_{<},\iota_{\Ob\nu}|\mathbb{R}|_{<})$
$f\in\continuous({\Ob\mu},{\Ob\nu})$. Really, it implies
