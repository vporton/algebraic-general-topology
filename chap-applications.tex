...
\fxnote{Consider also $\mathsf{RLD}$ instead of $\mathsf{FCD}$.}
...
\fxwarning{Add proof, rewrite in a more understandable way, $\mathbb{R}^n$ in general.} We probably should not yet consider infinite dimensional spaces,
...
\fxnote{This probably can be generalized for $C^n$ and $C^\infty$ curves. What about curves limited by an exponent?}
