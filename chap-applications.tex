...
\end{enumerate}
If $A$ is an interval, then $\overrightarrow{A}$ is called \emph{right interval} and $\overleftarrow{A}$ is called \emph{left interval}.
\end{defn}
...
$f\in\continuous(\overrightarrow{A};\overrightarrow{B})$.
\end{prop}
