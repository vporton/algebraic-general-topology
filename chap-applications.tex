...
\fxerror{Below in this section there were errors. The results may be wrong.}
...
\fxerror{The below is wrong as I wrongly assume that there is a countable set in every ultrafilter.
See \url{https://math.stackexchange.com/q/2304205/4876}.}
...
\begin{lem}
  ...
  $\bot \sqsubset \supfun{ | \mathbb{R} |_{\geq} } x \sqsubset \Delta_{>} + \alpha$.
\end{lem}

\begin{proof}
$\bot \sqsubset \supfun{ | \mathbb{R} |_{\geq} } x$ because
$\supfun{ | \mathbb{R} |_{\geq} } x \sqsupseteq \supfun{1} x = x$.

Take a decreasing sequence $z$ of real numbers such that $\im z\sqsupseteq x$.
\fxerror{It is at least non-obvious that such a sequence exists. For example $\mathbb{Q}$ cannot be represented as a monotone sequence.}

$\supfun{ | \mathbb{R} |_{\geq} } \im z \sqsubseteq 
\mathopen[z_0;z_0+\varepsilon_0\mathclose[ \cup \mathopen[z_1;z_1+\varepsilon_1\mathclose[ \cup \dots$
for every $\varepsilon_i>0$.

Easy to show that we can take such $\varepsilon_i$ that
$\mathopen[z_0;z_0+\varepsilon_0\mathclose[ \cup \mathopen[z_1;z_1+\varepsilon_1\mathclose[ \cup \dots
\nsqsupseteq \Delta_{>}$.

So we have $\supfun{ | \mathbb{R} |_{\geq} } x \nsqsupseteq \Delta_{>} + \alpha$.
But $\supfun{ | \mathbb{R} |_{\geq} } x \sqsubseteq \Delta_{>} + \alpha$ is obvious.
\end{proof}

\begin{lem}
  If $x$ is a convergent ultrafilter at the left of its
  limit point $\alpha$, $\bot \sqsubset \supfun{ | \mathbb{R} |_{\geq} } x \sqsubset \Delta_{<}+\alpha$.
\end{lem}

\begin{proof}
$\bot \sqsubset \supfun{ | \mathbb{R} |_{\geq} } x$ because $\supfun{ | \mathbb{R} |_{\geq} } x \sqsupseteq \supfun{1}x = x$.
...
\begin{lem}
  If $x$ is a convergent ultrafilter at the right of its limit point $\alpha$,
  $\bot \sqsubset \supfun{ | \mathbb{R} | } x \sqsubset \Delta_{>} + \alpha$.
\end{lem}

\begin{proof}
$\bot \sqsubset \supfun{ | \mathbb{R} | } x$ because
$\supfun{ | \mathbb{R} | } x \sqsupseteq \supfun{1} x = x$.

Take a decreasing sequence $z$ of real numbers such that $\im z\sqsupseteq x$.

$\supfun{ | \mathbb{R} | } \im z \sqsubseteq 
\mathopen]z_0-\varepsilon_0;z_0+\varepsilon_0\mathclose[ \cup \mathopen]z_1-\varepsilon_1;z_1+\varepsilon_1\mathclose[ \cup \dots$
for every $\varepsilon_i>0$.
...
So we have $\supfun{ | \mathbb{R} | } x \nsqsupseteq \Delta_{>} + \alpha$.
But $\supfun{ | \mathbb{R} | } x \sqsubseteq \Delta_{>} + \alpha$ is obvious.
\end{proof}
...
\begin{proof}
  ...
  = \supfun{| \mathbb{R} |} x \sqcap \supfun{\geq} x$.
\end{proof}
...
\begin{lem}
$\supfun{|\mathbb{R}|_{<}} x \asymp \supfun{|\mathbb{R}|_{\geq}} x$ for every ultrafilter~$x$.
\end{lem}

\begin{proof}
There exists either strictly increasing or strictly decreasing sequence~$z$ such that
$\im z\sqsupseteq x$.

It is easy to see that $\supfun{|\mathbb{R}|_{<}} \im z \asymp \supfun{|\mathbb{R}|_{\geq}} \im z$.
Thus $\supfun{|\mathbb{R}|_{<}} x \asymp \supfun{|\mathbb{R}|_{\geq}} x$.
\end{proof}
