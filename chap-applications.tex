...
\fxerror{Below is wrong because intervals don't contain infinities.}
...
\fxwarning{$|\mathfrak{A}|\{\max\mathfrak{A}\}$ may not contain $\max\mathfrak{A}$.}
\begin{enumerate}
\item $|\mathfrak{A}|\{x\} = \Delta(x)$; \fxwarning{Should coincide with the usual definition of order topology.}
...
\begin{prop}
~\fxerror{Wrong if $a$ is the maximum or minimum.}
\begin{enumerate}
\item $\rsupfun{|\mathfrak{A}|_{\geq}^{-1}}@X = @\setcond{a\in\mathfrak{A}}{\forall y>a:X\cap[a;y[\ne\emptyset}$;
\item $\rsupfun{|\mathfrak{A}|_{>}^{-1}}@X = @\setcond{a\in\mathfrak{A}}{\forall y>a:X\cap]a;y[\ne\emptyset}$;
\item $\rsupfun{|\mathfrak{A}|_{\leq}^{-1}}@X = @\setcond{a\in\mathfrak{A}}{\forall x<a:X\cap]x;a]\ne\emptyset}$.
\item $\rsupfun{|\mathfrak{A}|_{<}^{-1}}@X = @\setcond{a\in\mathfrak{A}}{\forall x<a:X\cap]x;a[\ne\emptyset}$.
\end{enumerate}
\end{prop}
