...
\fxerror{Below in this section there are errors. The results may be wrong.}
...
\begin{lem}
  ...
  \fxerror{Wrong because $\supfun{ | \mathbb{R} |_{\geq} } x \sqsupseteq \supfun{1}x =  x$.}
\end{lem}
...
\begin{proof}
  ...
  $\supfun{ | \mathbb{R} |_{\geq} } x \sqsubseteq ?? \sqsubseteq \supfun{ | \mathbb{R}
