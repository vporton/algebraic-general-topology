...
of them which are required for disproving this formula and for completeness
...
\begin{prop}
  $| \mathbb{R} |_{\geq} \circ | \mathbb{R} |_{\geq} = | \mathbb{R}
  |_{\geq}$.
\end{prop}
...
\begin{proof}
  ...
  \supfun{ | \mathbb{R} |_{\geq} } X$ for some $X \in \up x$ and
