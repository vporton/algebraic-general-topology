...
$\nu = \Compl \bigsqcup_{a\in d}(a\circ |\mathbb{R}|_{\geq}\circ a^{-1}) =
\bigsqcup_{a\in d}\Compl(a\circ |\mathbb{R}|_{\geq}\circ a^{-1})$.

Then attempt to restore $(X;d)$ from the funcoid~$\nu$:
...
|[0;1]|_{\geq}\sqsubseteq \bigsqcup_{a\in d}(f^{-1}\circ a\circ |\mathbb{R}|_{\geq}\circ a^{-1}\circ f) \Leftrightarrow ?? \Leftrightarrow
f\in d$.
If $f\in d$ then $f^{-1}\circ a\circ |\mathbb{R}|_{\geq}\circ a^{-1}\circ f\sqsubseteq |\mathbb{R}|_{\geq} \sqcap [0;1]\times[0;1] =
|\mathbb{R}|_{\geq}$. Thus $f\in d \Rightarrow |[0;1]|_{\geq}\sqsubseteq \bigsqcup_{a\in d}(f^{-1}\circ a\circ |\mathbb{R}|_{\geq}\circ a^{-1}\circ f)$.
Let now $|[0;1]|_{\geq}\sqsubseteq \bigsqcup_{a\in d}(f^{-1}\circ a\circ |\mathbb{R}|_{\geq}\circ a^{-1}\circ f)$. Then ??

\fxwarning{Counterexample: paths are twice clock-wise paths in the unit circle. This can't be expressed a pair of funcoids.}
