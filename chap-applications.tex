...
$R(p;d;\phi) = \setcond{(p_0+x;p_1+y)}{\arctan\frac{y}{x}<\phi+\arctan{d}}$ \fxerror{Wrong sign of $\arctan$ argument} for a plane point~$p$, direction (unit vector)~$d$ and an angle~$\phi$.

$W(p;d) = \bigsqcap\setcond{R(d;\phi)}{\phi\in\mathbb{R},\phi>0}$.
