...
\begin{enumerate}
\item $\rsupfun{\rsupfun{|\mathbb{R}|_{\geq}^{-1}}}@X = @\setcond{a\in\mathbb{R}}{\forall\epsilon>0:X\cap[a;a+\epsilon[\ne\emptyset}$;
\item $\rsupfun{\rsupfun{|\mathbb{R}|_{\leq}^{-1}}}@X = @\setcond{a\in\mathbb{R}}{\forall\epsilon>0:X\cap]a-\epsilon;a]\ne\emptyset}$.
\end{enumerate}
\end{xca}
...
\fxnote{Consider generalized continuity $f\in\continuous((A;|A|_{\geq});(B;|B|_{\geq}))$.}
\end{thm}
