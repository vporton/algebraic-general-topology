...
\begin{proof}
Equivalently transform $f\in\continuous(I;Q)$; $f\circ I\sqsubseteq Q\circ f$; (theorem~\bookref{rld-meta}, provided that $f$ is injective)
...
\begin{proof}
Equivalently transform $f\in\continuous(I;Q)$; $f\circ I\sqsubseteq Q\circ f$; (theorem \bookref{metcomp-thm})
??
