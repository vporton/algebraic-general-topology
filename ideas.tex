...
Properties of my ``straight'' maps can be also described using the term \emph{order embedding}. This allows to shorten some theorems.
It was really stupid that I have not noticed that most of ``straight'' functions considered by me are really order embeddings.
