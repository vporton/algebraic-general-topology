...
$\supfun{f}X=\atoms X$ defines a co-complete funcoid. What is $\supfun{f^{-1}}$? what is $\supfun{f}\mathcal{X}$?
Note that $\atoms$ can be understood both as atoms on sets and atoms on filters (that is the set of ultrafilters).

New proposition: $g\circ f = \bigsqcap^{\mathsf{FCD}} \setcond{G\circ F}{F\in\up^{\Gamma} f, G\in\up^{\Gamma} g}$ follows
from the definition of composition on $\mathfrak{F}\Gamma$.
