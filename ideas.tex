...
Example that $\Compl f\sqcup\CoCompl f\ne f$ (for both funcoids and reloids).
Also: How completion of reloids is related with oblique products?

Every funcoid (reloid) is a join of monovalued funcoids (reloids).
