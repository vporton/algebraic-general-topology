...
A funcoid or pointfree funcoids can be turned into a semigroup
action also by the formula: $\supfun{f}(x,y)=(\supfun{f}(x),\supfun{f^{-1}}(y))$ (on the left $\supfun{}$ denotes the semigroup action, on the right it denotes components of the funcoid.)
