...
Conjecture: $g\circ f = \bigsqcap^{\mathsf{FCD}} \setcond{G\circ F}{F\in\up^{\Gamma} f, G\in\up^{\Gamma} g}$.
Prove conjecture ``$\forall H\in\up(g\circ f)\exists F\in\up f,G\in\up g: H\sqsupseteq G\circ F$ for every composable funcoids $f$ and $g$.''
using this.
