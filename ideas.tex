...
Something like (formulate exactly) $\lim_{x\to\alpha} f(x) = \beta$ iff
$x\to \alpha \Rightarrow f(x)\to \beta$. Is
$g(x)\to \alpha \Rightarrow f(x)\to \beta$ equivalent to
$\lim_{x\to\alpha} g^{-1}f(x) = \beta$?
