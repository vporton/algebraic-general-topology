...
Principal pointfree funcoid can be defined in two ways:
mapping (in both directions) pricipal (or central) elements to principal or complete and co-complete. Need to generalize theorems about $\up$ to pointfree funcoids.
