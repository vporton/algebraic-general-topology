...
\begin{example}
$f=\mathbb{R}|_{[0;1]}$ (where $\mathbb{R}$ denotes usual topology on real line),
$g=\mathbb{R}|_{[0;1]}$ (where $\mathbb{R}$ denotes usual uniformity on real line).
Then $\rsupfun{f \times^{(A)} f} x = \rsupfun{f}\dom x\times^{\mathsf{RLD}}\rsupfun{f}\im x = \dom x\times^{\mathsf{RLD}}\im x\nsqsubseteq g$
