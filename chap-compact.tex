...
\begin{prop}\label{ff-ge-g}
  ...
  \fxerror{This proposition seems wrong because it proves theorem~\ref{cmp-main} without using compactness.}
\end{prop}
...
\begin{prop}\label{vmv}
  (attempt to generalize statement~2 in page~205 of Russian Bourbaki)
...
1^{\mathsf{RLD}}$. \fxwarning{Isn't it already proved in \ref{ff-ge-g}?}
\fxerror{It seems that \ref{ff-ge-g} is an error because it is ``proved'' without assumption of compactness.}
