...
endo-funcoid on $U$. If $\neg(A\rsuprel fB)\wedge A\sqcup B\in\dom f\sqcup\im f$
then $f$ is closed on $A$.\end{lem}
\begin{proof}
Let $A\sqcup B\in\dom f\sqcup\im f$.
\begin{align*}
...
\end{proof}
\begin{cor}
If $\neg(A\rsuprel fB)\wedge A\sqcup B\in\dom f\sqcup\im f$ then
$f$ is closed on $A\setminus B$ for a funcoid $f\in\mathsf{FCD}(U;U)$
for every sets $U$ and typed sets $A,B\in\mathscr{T}U$.\end{cor}
\begin{proof}
Let $\neg(A\rsuprel fB)\wedge A\sqcup B\in\dom f\sqcup\im f$. Then
\[
\lnot((A\setminus B)\rsuprel fB)\land(A\setminus B)\sqcup B\in\dom f\sqcup\im f.
\]
\end{proof}
\begin{lem}
If $\neg(A\rsuprel fB)\wedge A\sqcup B\in\dom f\sqcup\im f$ then
...
\begin{proof}
Let $\neg(A\rsuprel fB)\wedge A\sqcup B\in\dom f\sqcup\im f$. From
...
\[
\forall X\in\mathscr{T}(\Ob\mu)\setminus\{\bot^{\mathscr{T}(\Ob\mu)}\},Y\in\mathscr{T}(\Ob\mu)\setminus\{\bot^{\mathscr{T}(\Ob\mu)}\}:(X\sqcup Y=A\Rightarrow X\rsuprel{\mu}Y).
\]
\end{defn}
\begin{obvious}
...
\begin{defn}
\index{connectivity reloid}\emph{Connectivity reloid} $S^{\ast}(\mu)$
...
\item \label{princ-conn-rld}$\uparrow^{U}A$ is connected regarding $\uparrow^{\mathsf{RLD}}\mu$.
\item \label{princ-conn-fcd}$\uparrow^{U}A$ is connected regarding $\uparrow^{\mathsf{FCD}}\mu$.
\end{enumerate}
\end{thm}
\begin{proof}
~
...
\begin{align*}
S^{\ast}(\uparrow^{\mathsf{RLD}}\mu\sqcap(\uparrow^{U}A\times^{\mathsf{RLD}}\uparrow^{U}A)) & =\\
S^{\ast}(\uparrow^{\mathsf{RLD}}(\mu\sqcap(A\times A))) & =\\
\uparrow^{\mathsf{RLD}}S(\mu\sqcap(A\times A)).
\end{align*}
So
\begin{align*}
S^{\ast}(\uparrow^{\mathsf{RLD}}\mu\sqcap(\uparrow^{U}A\times^{\mathsf{RLD}}\uparrow^{U}A))\sqsupseteq\uparrow^{U}A\times^{\mathsf{RLD}}\uparrow^{U}A & \Leftrightarrow\\
\uparrow^{\mathsf{RLD}(U;U)}S(\mu\sqcap(A\times A))\sqsupseteq\uparrow^{\mathsf{RLD}}(A\times A)=\uparrow^{U}A\times^{\mathsf{RLD}}\uparrow^{U}A.
\end{align*}
...
\begin{conjecture}
Let $\mathcal{A}$ be a filter on a set $U$ and $F$ is a $\mathbf{Rel}$-endomorphism
on $U$.
...
\begin{prop}
A filter $\uparrow^{\Ob\mu}A$ (for a set $A$) is connected regarding
an endoreloid $f$ iff it is connected regarding the endofuncoid $\tofcd f$.\end{prop}
\begin{proof}
$\uparrow^{\Ob\mu}A$ is connected regarding a reloid $f$ iff $A$
...
\begin{align*}
\forall F\in\up f\forall\mathcal{X},\mathcal{Y}\in\mathscr{F}(\Ob f)\setminus\{\bot^{\mathscr{F}(\Ob f)}\}:(\mathcal{X}\sqcup\mathcal{Y}=\uparrow^{\Ob f}A\Rightarrow\mathcal{X}\suprel{\uparrow^{\mathsf{FCD}}F}\mathcal{Y}) & \Leftrightarrow\\
\forall\mathcal{X},\mathcal{Y}\in\mathscr{F}(\Ob f)\setminus\{\bot^{\mathscr{F}(\Ob f)}\}\forall F\in\up f:(\mathcal{X}\sqcup\mathcal{Y}=\uparrow^{\Ob f}A\Rightarrow\mathcal{X}\suprel{\uparrow^{\mathsf{FCD}}F}\mathcal{Y}) & \Leftrightarrow\\
\forall\mathcal{X},\mathcal{Y}\in\mathscr{F}(\Ob f)\setminus\{\bot^{\mathscr{F}(\Ob f)}\}(\mathcal{X}\sqcup\mathcal{Y}=\uparrow^{\Ob f}A\Rightarrow\forall F\in\up f:\mathcal{X}\suprel{\uparrow^{\mathsf{FCD}}F}\mathcal{Y}) & \Leftrightarrow\\
\forall\mathcal{X},\mathcal{Y}\in\mathscr{F}(\Ob f)\setminus\{\bot^{\mathscr{F}(\Ob f)}\}(\mathcal{X}\sqcup\mathcal{Y}=\uparrow^{\Ob f}A\Rightarrow\mathcal{X}\suprel{\tofcd f}\mathcal{Y})
\end{align*}
that is when the set $\uparrow^{\Ob\mu}A$ is connected regarding
...
\section{Algebraic properties of $S$ and $S^{\ast}$}
\begin{thm}
...
\bigsqcap_{R\in\up S^{\ast}(f)}^{\mathsf{RLD}}S(S(R)) & =\\
\bigsqcap_{R\in\up S^{\ast}(f)}^{\mathsf{RLD}}S(R) & =\\
S^{\ast}(f).
\end{align*}
