...
\begin{defn}
$\im f = \setcond{X \in \Ob (\mathcal{C})}{\mathcal{E}^{\Dst
f, X} \circ f \sim f} = \setcond{X \in \Ob
(\mathcal{C})}{\mathcal{E}^{X, \Dst f} \circ \mathcal{E}^{\Dst f,
X} \circ f = f}$.
\end{defn}
...
\begin{proof}
$E=\mathcal{E}^{X, \Dst f} \circ \mathcal{E}^{\Dst f, X}$ is
a monovalued morphism. So it is meta-monovalued and thus
for $X,Y\in\im f$ we have
