...
\fxnote{Triangular diagram for the filtrators of filters,
filtrators of unfixed filters, filtrator of filter on the
poset of small sets (for example to describe core part).}
