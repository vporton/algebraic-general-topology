...
whenever $X,Y\sqsubseteq A\sqcap B$?
\end{enumerate}

For a partially ordered category with restricted identities introduce additional axiom $X\sqsubseteq Y\Rightarrow
\id^{\mathcal{C}(A,B)}_X\sqsubseteq\id^{\mathcal{C}(A,B)}_Y$.

For dagger categories with restricted identities introduce additional axiom
