...
\fxnote{More general that filters on sets and category
$\mathbf{Rel}$.}
...
$\mathcal{Y} = \mathcal{X} \div A$ and
$\mathcal{X} = \mathcal{Y} \div B$.
\fxerror{Don't confuse with equivalence of filters in
