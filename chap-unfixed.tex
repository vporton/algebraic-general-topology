...
\item\label{uf-sim-sb} $\iota_{A_1,B_1}f\sqsupseteq g$ and $\iota_{A_0,B_0}g\sqsupseteq f$.
\end{enumerate}
\end{thm}
...
\item[\ref{uf-sim-cond-eq}$\Rightarrow$\ref{uf-sim-cond-sim}]
Let $\iota_{A_1, B_1} f = g$ and $\iota_{A_0, B_0} g = f$.

$\iota_{A_1, B_1} \iota_{A_0, B_0} g = g$;

$\mathcal{E}^{B_0, B_1} \circ \mathcal{E}^{B_1, B_0} \circ g \circ
\mathcal{E}^{A_0, A_1} \circ \mathcal{E}^{A_1, A_0}=g$;
