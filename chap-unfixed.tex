...
\fxerror{Wrong order of definitions.}
...
~
\begin{enumerate}
\item $\im f = \setcond{Y \in \subsets\Dst f}{\mathcal{E}_{\mathcal{C}}^{\Dst
f, Y} \circ f \sim f} = \setcond{Y \in \subsets\Dst f}{\mathcal{E}_{\mathcal{C}}^{Y, \Dst f} \circ \mathcal{E}_{\mathcal{C}}^{\Dst f,
Y} \circ f = f}$;
\item $\dom f = \setcond{X \in \subsets\Src f}{f\circ\mathcal{E}_{\mathcal{C}}^{X, \Src
f} \sim f} = \setcond{X \in \subsets\Src f}{f\circ\mathcal{E}_{\mathcal{C}}^{\Src f, X} \circ \mathcal{E}_{\mathcal{C}}^{X, \Src f} = f}$.
\end{enumerate}
\end{defn}
...
~
\begin{enumerate}
\item $\operatorname{Im} f = \setcond{Y \in \Ob (\mathcal{C})}{\mathcal{E}_{\mathcal{C}}^{\Dst
f, Y} \circ f \sim f} = \setcond{Y \in \Ob
(\mathcal{C})}{\mathcal{E}_{\mathcal{C}}^{Y, \Dst f} \circ \mathcal{E}_{\mathcal{C}}^{\Dst f,
Y} \circ f = f}$;
\item $\operatorname{Dom} f = \setcond{X \in \Ob (\mathcal{C})}{f\circ\mathcal{E}_{\mathcal{C}}^{X, \Src
f} \sim f} = \setcond{X \in X \in \Ob (\mathcal{C})}{f\circ\mathcal{E}_{\mathcal{C}}^{\Src f, X} \circ \mathcal{E}_{\mathcal{C}}^{X, \Src f} = f}$.
\end{enumerate}
\end{defn}
...
TODO: Define equivalence of morphisms using $\dom$ and $\im$.

\begin{defn}
I call two morphisms $f\in\mathcal{C}(A_0,B_0)$ and
$g\in\mathcal{C}(A_1,B_1)$
of a category under~$\mathbf{Rel}$ \emph{equivalent} when
