...
\begin{prop}
  ...
  \sqsupseteq A_0 \sqcap C_0$, $B_1 \sqsupseteq A_1 \sqcap C_1$ and $f : A_0
  \rightarrow A_1$.
\end{prop}
...
\begin{proof}
Define $Y' = Y \sqcap \Dst f$ for every $Y \in \Ob (\mathcal{C})$.

Then $\mathcal{E}_{\mathcal{C}}^{Y, \Dst f} \circ
\mathcal{E}_{\mathcal{C}}^{\Dst f, Y} = \mathcal{E}_{\mathcal{C}}^{Y', \Dst f} \circ
...
$\mathcal{E}_{\mathcal{C}}^{\Dst f, \Dst f}=1^{\mathcal{C}}$.
\end{proof}
...
\begin{proof}
  ...
  \circ \mathcal{E}^{\Dst f, Y} = (\Dst f, B, \id_{Y \sqcap
  \Dst f \sqcap B}) = (Y, B, \id_{Y \sqcap B}) \circ (\Dst f, Y,
  \id_{Y \sqcap \Dst f}) =\mathcal{E}^{Y, B} \circ
