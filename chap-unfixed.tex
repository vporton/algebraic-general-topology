...
Y} \circ f = f}$;
\item $\operatorname{Dom} f = \setcond{X \in \Ob (\mathcal{C})}{f\circ\mathcal{E}_{\mathcal{C}}^{\Src f, X} \circ \mathcal{E}_{\mathcal{C}}^{X, \Src f} = f}$.
\end{enumerate}
\end{defn}
...
~
\begin{enumerate}
\item $\im f = \setcond{Y\in\mathfrak{Z}}{Y\sqsubseteq\Dst f}\cap\operatorname{Im} f$;
\item $\dom f = \setcond{X\in\mathfrak{Z}}{X\sqsubseteq\Src f}\cap\operatorname{Dom} f$.
\end{enumerate}
\end{defn}
