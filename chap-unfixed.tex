...
\begin{gather*}
X\times_{A_0,B_0}Y=
\id^{\mathcal{C}(B_0,B_0)}_Y\circ
\top^{\mathcal{C}(A_0,B_0)}\circ
\id^{\mathcal{C}(A_0,A_0)}_X; \\
X\times_{A_1,B_1}Y=
\id^{\mathcal{C}(B_1,B_1)}_Y\circ
\top^{\mathcal{C}(A_1,B_1)}\circ
\id^{\mathcal{C}(A_1,A_1)}_X;
\end{gather*}
