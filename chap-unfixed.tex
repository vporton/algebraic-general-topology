...
\begin{enumerate}
\item Let~$T$ be an unfixed morphism. $f\mapsto[f]$ and $F\mapsto\iota_{A,B}F$ are mutually inverse bijections
between the lattice~$DT$ and $Dt$ whenever~$t\in T$.
\item Let~$A$ and~$B$ be objects. $f\mapsto[f]$ and $F\mapsto\iota_{\Src t,\Dst t}F$
