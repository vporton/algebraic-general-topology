...
\begin{defn}
The category \emph{with binary product} is a category with
restricted identities and axiom
...
\fxerror{Category with binary products is an already used
term!}
\end{defn}

\begin{prop}
For every category with binary product
\[X\times_{A,B}Y=
...
\fxnote{Say this in terms of~$\iota$}
\end{prop}
