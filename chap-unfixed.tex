...
because of theorem~\bookref{mathscrs-iso} and
...
$X\in\subsets B$. So $\mathcal{X}\cap\subsets B$. If
...
It remains to apply lemma~\bookref{three-loop-lem} (taking into account the proof of theorem~\bookref{mathscrs-iso}.
\end{proof}
