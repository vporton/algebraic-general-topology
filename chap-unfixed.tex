...
\begin{thm}
\fxnote{Generalize for $\operatorname{DOM}$ and $\operatorname{IM}$?
Also what's about $\operatorname{Dom}$ and $\operatorname{Im}$?}
$\dom[f]=[\dom f]$ and $\im[f]=[\im f]$ for every
morphism~$f$ of a category with restricted identities.
\end{thm}
