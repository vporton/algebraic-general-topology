...
$\mathsf{RLD}$ with
$\mathcal{X}\times_{A,B}\mathcal{Y}=
(\mathcal{X}\div A)\times^{\mathsf{RLD}}
(\mathcal{X}\div B)$
for every unfixed filters~$\mathcal{X}$
and~$\mathcal{Y}$
...
If $F\in\up f$ and $G\in\up g$ then
$F\in\GR f$ and $G\in\GR g$. Consequently
$F\in\GR\mathscr{S}f$, $G\in\GR\mathscr{S}g$. So
$g\circ f\sqsubseteq G\circ F$ and thus??
$\mathscr{S}(g\circ f)\sqsubseteq
...
$H\supseteq
G\div(\Src g\times\Dst g))\circ
(F\div(\Src f\times\Dst f))=
G\circ F\in\up(\mathscr{S}(g\circ f))$. So
$\mathscr{S}g\circ\mathscr{S}f\sqsubseteq
\mathscr{S}(g\circ f)$.
