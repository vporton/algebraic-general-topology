...
~
\begin{enumerate}
\item $\mathscr{S}$ from funcoids is an order embedding and a functor.
\item $\mathscr{S}$ from unfixed funcoids is an order embedding and a functor (that is semigroup homomorphism).
\end{enumerate}
\end{prop}
