...
Let~$f$ be a funcoid (TODO: or it can be unfixed funcoid).
Define pointfree funcoid~$\mathscr{S}f$ between unfixed
filters as:
...
\begin{proof}
To prove it use the lemma
and that the $\div A$ in the right part of the formula
...
Prove that~$\mathscr{S}$ is an order embedding and
a functor.

Also consider $\mathscr{S}(X\times Y)$ and
$\mathscr{S}\id_X$.
