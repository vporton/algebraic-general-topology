...
$\iota_{A_1,B_1}f=g$ and $\iota_{A_0,B_0}g=f$, provided
that $\im f$, $\dom f$, $\im g$ and~$\dom g$ are defined.
\end{thm}
...
TODO: Order of unfixed morphisms (for category with
restricted identities \emph{of correct order}).
Does complete lattice of morphisms turns into complete
lattice of unfixed morphisms? Filtrators of unfixed
morphisms.
