...
\section{Poset of unfixed filters}
...
\begin{thm}
The relation~$\sqsubseteq$ on the set of all small filters
defined by the formula $x\sqsubseteq y \Leftrightarrow [x]\sqsubseteq[y]$ is a partial order which coincides with
the customary order of filters for filters of the same base
set.
\end{thm}
