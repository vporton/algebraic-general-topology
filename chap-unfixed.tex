...
\[\id^{\mathcal{C}(\Src f,\Dst f)}_Y \circ \top^{\mathcal{C}(\Src f,\Dst f)} \sqsupseteq f \Rightarrow \id_Y \circ f
...
\begin{proof}
\[\id^{\mathcal{C}(\Src f,\Dst f)}_Y \circ \top^{\mathcal{C}(\Src f,\Dst f)} \sqsupseteq f \Leftrightarrow
