...
properties (cf. distributivity below) of the poset of unfixed morphisms:
...
$\setcond{f}{A\in\operatorname{DOM}f,B\in\operatorname{IM}f}$
...
\begin{proof}
Take morphisms $f$, $g$, $h$.
Then?? $[f\sqcap(g\sqcup h)]=$
??
\end{proof}
