...
\section{The lattice of filters on small sets}
...
\begin{prop}
Values of this embedding are filters on the poset of
...
\fxnote{Define $\mathcal{X}\div B$ for every unfixed
filter~$\mathcal{X}$ and set~$B$. Research its properties.}
