...
\begin{prop}
$\iota_{A, B} \iota_{X, Y} f = \iota_{A, B} f$ for every sets $A$, $B$, $X$,
$Y$ whenever $\dom f$ and $\im f$ are filters and $X \in
\dom f$, $Y \in \im f$.
\end{prop}

\begin{proof}
$\iota_{A, B} f =\mathcal{E}^{\Dst f, B} \circ f \circ
(\mathcal{E}^{\Src f, A})^{-1} =\mathcal{E}^{\Dst f, B} \circ
\mathcal{E}^{Y, \Dst f} \circ \mathcal{E}^{\Dst f, Y} \circ f
\circ (\mathcal{E}^{\Src f, X})^{-1} \circ
(\mathcal{E}^{X, \Src f})^{-1} \circ
(\mathcal{E}^{\Src f, A})^{-1} = ? ? =\mathcal{E}^{Y, B} \circ
\mathcal{E}^{\Dst f, Y} \circ f \circ (\mathcal{E}^{\Src
f, X})^{-1} \circ (\mathcal{E}^{X, A})^{-1} = \iota_{A, B} \iota_{X, Y} f$.
\end{proof}
