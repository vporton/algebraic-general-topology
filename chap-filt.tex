...
If $\bot\in\bigsqcap^{\mathfrak{A}}S$ then there are $K_{i}\in\bigcup S$
...
from which easily follows $\mathcal{F}_{0}\sqcap^{\mathfrak{A}}\ldots\sqcap^{\mathfrak{F}}\mathcal{F}_{n}=\bot$
