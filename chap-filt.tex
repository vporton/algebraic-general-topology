...
\begin{thm}
\fxnote{It seems enough for $\mathfrak{Z}$ to be bounded from below/above.}
~
\begin{enumerate}
...
\begin{proof}
  ...
  $R$ is nonempty because exist $X \in \up \mathcal{A}$ and $Y \in
  \up \mathcal{B}$ and $R \ni X \sqcup^{\mathfrak{Z}} Y$.

  Let $A, B \in R$. Then $A, B \in \up \mathcal{A}$; so exists $C \in
  \up \mathcal{A}$ such that $C \subseteq A \land C \subseteq B$.
  Analogously exists $D \in \up \mathcal{B}$ such that $D \subseteq A \land
  D \subseteq B$. Let $E = C \sqcup^{\mathfrak{Z}} D$. Then $E \in \up
  \mathcal{A}$ and $E \in \up \mathcal{B}$; $E \in R$ and $E \subseteq A \land
  E \subseteq B$. So $R$ is a filter base.
...
\item\label{f-atoms-join-prim} $(\mathfrak{A},\mathfrak{Z})$
  is a primary filtrator over a distributive lattice with greatest element.
...
Find a common generalization of two theorems for primary
filtrators~$(\mathfrak{A},\mathfrak{Z})$:
\begin{enumerate}
