...
Thus
\begin{multline*}
x=\mylamdba i{\dom x}{x_{i}}=\mylamdba i{\dom x}{\bigsqcup\atoms x_{i}=\\
\mylamdba i{\dom x}{\bigsqcup\mylamdba{j}{\dom x}{\begin{cases}
\atoms x_{i} & \text{if }j=i\\
\bot^{\mathfrak{A}_i} & \text{if }j\ne i
\end{cases}}}}=\\
\mylamdba i{\dom x}{\bigsqcup\atoms \begin{cases}
x_{i} & \text{if }j=i\\
\bot^{\mathfrak{A}_i} & \text{if }j\ne i
\end{cases}}=\\
\bigsqcup\mylamdba i{\dom x}{\atoms \begin{cases}
x_{i} & \text{if }j=i\\
\bot^{\mathfrak{A}_i} & \text{if }j\ne i
\end{cases}}=
\bigsqcup\atoms x.
