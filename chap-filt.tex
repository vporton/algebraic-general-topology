...
\item [{\ref{uni-join-fltr}$\Rightarrow$\ref{uni-join-conc}}] $(a\sqcup^{\mathfrak{A}}b)^{\ast}=(a\sqcup^{\mathfrak{A}}b)^{+}=\overline{\Cor'(a\sqcup^{\mathfrak{A}}b)}=\overline{\Cor'a\sqcup^{\mathfrak{Z}}\Cor'b}=\overline{\Cor'a}\sqcap^{\mathfrak{Z}}\overline{\Cor'b}=a^{\ast}\sqcap^{\mathfrak{Z}}b^{\ast}=(a\sqcup^{\mathfrak{A}}b)^{+}=a^{\ast}\sqcap^{\mathfrak{A}}b^{\ast}$
...
$(a\sqcap^{\mathfrak{A}}b)^{\ast} = \overline{\Cor'(a\sqcap^{\mathfrak{A}}b)} = \overline{\Cor'a}\sqcap^{\mathfrak{Z}}\overline{\Cor'b} =
\overline{\Cor'a\sqcup^{\mathfrak{Z}}\Cor'b} = a^{\ast}\sqcup^{\mathfrak{A}}b^{\ast}$
...
\item [\ref{meet-dpseudo-fltr}$\Rightarrow$\ref{meet-dpseudo-res}] $(a\sqcap^{\mathfrak{A}}b)^{+}=\overline{\Cor'(a\sqcap^{\mathfrak{A}}b)} =
...
using theorems~\ref{cocompl-cor}, \ref{cor-eq} and the fact that filtered filtrator is join-closed.
\end{description}
\end{proof}
...
down-aligned filtrator with binarily meet-closed core, with co-separable core $\mathfrak{Z}$
...
$(a\sqcup^{\mathfrak{A}}b)^{+}=\overline{\Cor'(a\sqcup^{\mathfrak{A}}b)} =
...
using theorems~\ref{dual-core-join}, \ref{cocompl-cor}.
\end{description}
\end{proof}
