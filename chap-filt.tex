...
The following is an implications tuple:
\fxwarning{Generalize dependent theorems.}
\begin{enumerate}
...
\end{proof}
\begin{thm}
\fxerror{This theorem was with an error in conditions.
Check dependent theorems.}
The following is an implications tuple:
\begin{enumerate}
...
\fxnote{Is it enough to be weakly down-aligned?}
...
filtrator.
\end{enumerate}
\fxnote{Analogous theorem for weakly aligned?}
\end{obvious}
\begin{prop}
...
\fxnote{Enough to be weakly up-aligned?}
\end{obvious}
