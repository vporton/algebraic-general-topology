...
Take $y=\mylamdba{j}{\dom\mathfrak{A}}{\begin{cases}\bot^{\mathfrak{A}_j}&\text{ if }j\ne i;\\x&\text{ if }j=i.\end{cases}}$
...
\[
\setcond{\mylamdba{i}{\dom\mathfrak{A}}{\left(\begin{cases}\bot^{\mathfrak{A}_i}&\text{ if }i\ne k;\\a&\text{ if }i=k\end{cases}\right)}}{k\in\dom\mathfrak{A}, a\in\atoms^{\mathfrak{A}_{k}}}.
\]
\end{obvious}
\begin{prop}
...
\bigsqcup\mylamdba i{\dom x}{\atoms x_{i}}=\\
\bigsqcup\mylamdba i{\dom x}{\Pr_i\atoms x}=
\bigsqcup\mylamdba i{\dom x}{\setcond{a_i}}{a\in\atoms x}\sqsubseteq
\bigsqcup\atoms x
\end{multline*}
because $\mylamdba i{\dom x}{\setcond{a_i}}{a\in\atoms x}$ is join of a subset of $\atoms x$.
Thus $x=\bigsqcup\atoms x$.
\end{proof}
\begin{cor}
