...
\begin{defn}
\index{filter!on a set}A filter on a set $ U$ is a $\mathcal{F}\in\subsets\subsets U$
such that:
\begin{enumerate}
\item $\forall A,B\in\mathcal{F}:A\cap B\in\mathcal{F}$;
\item $\forall A,B\in\subsets U:(A\in\mathcal{F}\land B\supseteq A\Rightarrow B\in\mathcal{F})$.
\end{enumerate}
\end{defn}
\begin{xca}
...
\begin{obvious}
The non-proper filter is $\subsets U$.\end{obvious}
\begin{rem}
...
\fxwarning{This section was checked for errors but less
carefully than the rest of the book.}
