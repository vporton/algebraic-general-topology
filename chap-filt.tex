...
\begin{thm}
\fxnote{It seems enough for $\mathfrak{Z}$ to be bounded from below/above. Well, it seems to be the same being
bounded above and having max element!}
~
\begin{enumerate}
