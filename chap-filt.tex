...
\begin{lem}
$\mathscr{S}\mathcal{A}\cap\subsets A$ is a filter on $A$.
\end{lem}

\begin{proof}
That $\mathscr{S}\mathcal{A}\cap\subsets A$ is an upper set on~$A$ is obvious. Let $X_0,X_1\in\mathscr{S}\mathcal{A}\cap\subsets A$.
Then $X_0\cap X_1\in\mathscr{S}\mathcal{A}\cap\subsets A$
because~$\mathscr{S}\mathcal{A}$ is a filter (as proved
above).
\end{proof}
...
\[
\mathcal{A}\div A=\mathscr{S}\mathcal{A}\cap\subsets A.
\]
\end{prop}

\begin{proof}
We know that $\mathscr{S}\mathcal{A}\cap\subsets A$ is a filter.

If $P \in \mathscr{S}\mathcal{A}\cap\subsets A$ then $P \in \subsets A$ and $Y\cap A
...
\subsets A$. Thus $P \in \mathscr{S}\mathcal{A}\cap\subsets A$.
\end{proof}
...
\begin{proof}
$\mathcal{A}\div A=
\mathscr{S}\mathcal{A}\cap\subsets A =
\setcond{\text{small set }K}{
\exists X\in\mathcal{A}:X\subseteq K}\cap\subsets A =
\setcond{\text{small set }K}{
...
\fxnote{Both previous propositions can be generalized into
$B\in\mathscr{S}\mathcal{A} \Rightarrow
\mathcal{A}\div B\sim\mathcal{A}$.}
...
$\exists Y\in\mathcal{A}:Y\cap B\subseteq X \Leftrightarrow
\exists Y\in\mathcal{B}:Y\cap B\subseteq X$
for every filters~$\mathcal{A}$,~$\mathcal{B}$ and
sets~$B$,~$X\in\subsets B$.
\end{lem}

\begin{proof}
Let $\mathcal{A}\sim\mathcal{B}$ that is there is a set~$P$
such that $P\in\mathcal{A}$, $P\in\mathcal{B}$ and
$\mathcal{A}\cap\subsets P=\mathcal{B}\cap\subsets P$.

$\exists Y\in\mathcal{A}:Y\cap B\subseteq X \Leftrightarrow
\exists Y\in\mathcal{A}\cap\subsets P:Y\cap B\subseteq X
\lor
\exists Y\in\mathcal{A}:
(Y\supseteq P\land Y\cap B\subseteq X) \Leftrightarrow
\exists Y\in\mathcal{A}\cap\subsets P:Y\cap B\subseteq X
\lor
\exists Y\in\subsets\Base(\mathcal{A}):
(Y\supseteq P\land Y\cap B\subseteq X)$.

If there exists set~$Y$ such that
$Y\supseteq P\land Y\cap B\subseteq X$, then
take
$Y'=Y\cap\Base(\mathcal{A})\in\subsets\Base(\mathcal{A})$;
we have $Y'\supseteq P$ and $Y'\cap B\subseteq X$.

We've proved $\exists Y\in\subsets\Base(\mathcal{A}):
(Y\supseteq P\land Y\cap B\subseteq X) \Leftrightarrow
\exists Y:(Y\supseteq P\land Y\cap B\subseteq X)$.
...
Thus
$\exists Y\in\mathcal{A}:Y\cap B\subseteq X \Leftrightarrow
\exists Y\in\mathcal{B}:Y\cap B\subseteq X$ from symmetry.
\end{proof}
...
\begin{proof}
$\mathcal{A}\div B =
\setcond{X\in\subsets B}{\exists Y\in\mathcal{A}:Y\cap B\subseteq X} =
\text{(lemma)} =
\setcond{X\in\subsets B}{\exists Y\in\mathcal{B}:Y\cap B\subseteq X} =
\mathcal{B}\div B$.
\end{proof}
