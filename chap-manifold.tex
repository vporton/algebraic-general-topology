...
Consider the ``angle''~$T$ produced by two half-planes. Are the points of
...
Consider intersection of two lines on plane. The intersection may be considered
as a special point, because it has more connected components that the rest.
We don't want to consider it special, however.
