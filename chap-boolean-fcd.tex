...
$\mathfrak{A}$. So it a boolean lattice. \fxerror{Here and below disjoint union of boolean lattices is \emph{not} a boolean lattice
(because it has more than one minimal element). This is the solution of question of whether pointfree funcoids between boolean lattices form a boolean lattice.
(Recheck again! It seems to work for funcoids between finite posets.)}
