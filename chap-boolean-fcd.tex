...
\begin{prop}
  Every pointfree funcoid, whose source is completely starrish and whose destination is completely starrish and separable,
...
\begin{proof}
  ...
  \rsupfun{\supfun{f}} S$ are defined.
...
\begin{proof}
Using proposition~\bookref{bool-sep} and theorem~\bookref{bool-inf-distr}. \fxerror{The last theorem holds only for complete boolean lattices!}
\end{proof}
