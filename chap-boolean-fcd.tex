...
\begin{tabular}{c}pointfree funcoids\\ between powersets\end{tabular}
...
\& \& \begin{tabular}{c}antitone Galois\\ connections\\ between powersets\end{tabular}
...
\\
\& \begin{tabular}{c}Galois connections\\ between powersets\end{tabular}
\arrow[lu, shift left, "\begin{aligned}\scriptscriptstyle f\mapsto\left(f^\ast;Y\mapsto\bigsqcap_{y\in\subsets Y}f_{\ast}\lnot y\right)=\\
  \scriptscriptstyle\left(f^\ast;Y\mapsto\bigsqcap_{y\in Y}f_{\ast}\lnot\{y\}\right)\end{aligned}"]
\end{tikzcd}
% \end{sideways}
\end{figure}
% \end{sidewaysfigure}
