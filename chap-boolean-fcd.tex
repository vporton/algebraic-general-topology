...
\arrow[rr, shift left, "\begin{aligned}\scriptscriptstyle f\mapsto\left(X\mapsto\lnot\supfun{f}X;Y\mapsto\bigsqcap_{y\in\subsets Y\setminus\{\emptyset\}}\supfun{f^{-1}}y\right)=\\
