...
\fxnote{We can define \emph{product} in a system of sides, but only if it's bijective.
However, we can add axioms for product for any system of sides.
Hm, what about alternative definition of product (for example the ``second'' product) for reloids?}
