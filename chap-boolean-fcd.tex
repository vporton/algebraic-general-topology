...
\begin{prop}
$\Psi_2$ and~$\Psi_2^{-1}$ from the diagram at figure~\ref{fcd-diagram} preserve composition and identity and also reversal ($f\mapsto f^{-1}$).
...
Then $\Phi$ is an isomorphism (theorem~\bookref{bfunc-is-adj}) and
