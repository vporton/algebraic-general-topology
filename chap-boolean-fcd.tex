...
\begin{tikzcd}[row sep=4cm, column sep=1.8cm]
& \text{binary relations}
\arrow[rd, shift left, "r\mapsto\left(X\mapsto\setcond{y\in\subsets B}{\forall x\in A:x\mathrel{r}y}; Y\mapsto\setcond{x\in A}{\forall y\in\subsets B:x\mathrel{r}y}\right)"]
\arrow[ld, shift left, "r\mapsto\left(\supfun{r};\supfun{r^{-1}}\right)"] \\
\begin{tabular}{c}
