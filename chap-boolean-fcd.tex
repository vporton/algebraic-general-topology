...
Theorem~3.8 in~\cite{tprod-dist-lat} states:
Let $A$ be a non-atomic Boolean lattice. Then $A\otimes A$ is not a Boolean lattice.
Try to prove a similar theorem for pointfree funcoids. It suffices to prove that the
identity is not complemented.