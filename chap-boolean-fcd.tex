...
\arrow[ll, shift left, "\begin{aligned}\scriptscriptstyle f\mapsto\left(X\mapsto\lnot f_1 X;Y\mapsto\bigsqcup_{y\in\subsets Y}f_2 y\right)=\\
  \scriptscriptstyle\left(X\mapsto\lnot f_1 X;Y\mapsto\bigsqcup_{y\in Y}f_2\{y\}\right)\end{aligned}"]
\end{tikzcd}
% \end{sideways}
\end{figure}
% \end{sidewaysfigure}
