...
\begin{thm}
Let $f$ be a pointfree funcoid between atomic bounded separable meet-semilattices.
\begin{enumerate}
...
\item [{\ref{pf-f-at}}] \fxwarning{Check the proof for our new generality.} Let $\mathcal{Y}\in\mathscr{F}(\Dst f)$. Suppose
