...
\begin{thm} \fxwarning{This theorem was generalized. Generalize also it's consequences. Also note error below and consider it propogation to consequences.}
...
by propositions~\ref{pf-cap-dom} we have: \fxwarning{Check that we really have, strong separability is required for $\supfun{f}$ to be monotone.}
\[
