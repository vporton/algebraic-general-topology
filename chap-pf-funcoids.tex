...
\item \label{pf-ax:sing}$\forall A\in\mathfrak{Z}_0:\rsupfun 
...
\item [{\ref{pf-ax:fcd-full-fa-filt}$\Rightarrow$\ref{pf-ax:fcd-full-fa-set},~\ref{pf-ax:fcd-full-eq-filt}$\Rightarrow$\ref{pf-ax:fcd-full-eq-set}},~{\ref{pf-ax:fcd-full-eq-set}$\Rightarrow$\ref{pf-ax:sing}}] By
join-closedness of the core of $(\mathfrak{A};\mathfrak{Z}_{0})$.
\item [{\ref{pf-ax:sing}$\Rightarrow$\ref{pf-ax:fcd-full-eq-set}}] Using 
theorem~\ref{crit1},
\begin{align*}
